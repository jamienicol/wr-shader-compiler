...
void main ()
{
  ...
  if ((prim_yuv_format_39 == 1)) {
    ...
    tmpvar_54.z = texelFetch (sGpuCache, (tmpvar_47 + ivec2(1, 0)), 0).x;
    vec4 tmpvar_55;
    ...
    tmpvar_57.z = texelFetch (sGpuCache, (tmpvar_49 + ivec2(1, 0)), 0).x;
    vec4 tmpvar_58;
    ...
    tmpvar_60.z = texelFetch (sGpuCache, (tmpvar_51 + ivec2(1, 0)), 0).x;
    vec4 tmpvar_61;
    ...
    if ((prim_yuv_format_39 == 0)) {
      ...
      tmpvar_67.z = texelFetch (sGpuCache, (tmpvar_62 + ivec2(1, 0)), 0).x;
      vec4 tmpvar_68;
      ...
      tmpvar_70.z = texelFetch (sGpuCache, (tmpvar_64 + ivec2(1, 0)), 0).x;
      vec4 tmpvar_71;
      ...
      if ((prim_yuv_format_39 == 2)) {
        ...
        tmpvar_75.z = texelFetch (sGpuCache, (tmpvar_72 + ivec2(1, 0)), 0).x;
        vec4 tmpvar_76;
