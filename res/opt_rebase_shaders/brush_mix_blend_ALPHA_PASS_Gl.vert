...
void main ()
{
  ...
  if ((instance_segment_index_3 == 65535)) {
    ...
    vec4 tmpvar_35;
    tmpvar_35 = texelFetchOffset (sGpuCache, tmpvar_34, 0, ivec2(0, 0));
  ...
  vec4 tmpvar_51;
  tmpvar_51 = texelFetchOffset (sRenderTasks, tmpvar_50, 0, ivec2(1, 0));
  varying_vec4_0.xy = (((
    (vi_world_pos_29.xy * (tmpvar_51.y / max (0.0, vi_world_pos_29.w)))
   + texelFetchOffset (sRenderTasks, tmpvar_50, 0, ivec2(0, 0)).xy) - tmpvar_51.zw) / tmpvar_49);
  ...
  varying_vec4_1.xy = (((
   ...
   + texelFetchOffset (sRenderTasks, tmpvar_52, 0, ivec2(0, 0)).xy) - (tmpvar_51.zw * 
    (tmpvar_20.y / tmpvar_51.y)
  )) / tmpvar_49);
  varying_vec4_1.w = texelFetchOffset (sRenderTasks, tmpvar_52, 0, ivec2(1, 0)).x;
}
