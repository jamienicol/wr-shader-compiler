...
void main ()
{
  ...
  if ((prim_yuv_format_52 == 1)) {
    ...
    vec3 tmpvar_66;
    tmpvar_66.xy = mix (tmpvar_61.xy, tmpvar_61.zw, f_53);
    tmpvar_66.z = texelFetchOffset (sGpuCache, tmpvar_60, 0, ivec2(1, 0)).x;
    vec4 tmpvar_67;
    ...
    vec3 tmpvar_68;
    tmpvar_68.xy = mix (tmpvar_63.xy, tmpvar_63.zw, f_53);
    tmpvar_68.z = texelFetchOffset (sGpuCache, tmpvar_62, 0, ivec2(1, 0)).x;
    vec4 tmpvar_69;
    ...
    vec3 tmpvar_70;
    tmpvar_70.xy = mix (tmpvar_65.xy, tmpvar_65.zw, f_53);
    ...
    if ((prim_yuv_format_52 == 0)) {
      ivec2 tmpvar_72;
      tmpvar_72.x = int((uint(tmpvar_13.x) % 1024u));
      tmpvar_72.y = int((uint(tmpvar_13.x) / 1024u));
      vec4 tmpvar_73;
      tmpvar_73 = texelFetchOffset (sGpuCache, tmpvar_72, 0, ivec2(0, 0));
      ivec2 tmpvar_74;
      tmpvar_74.x = int((uint(tmpvar_13.y) % 1024u));
      tmpvar_74.y = int((uint(tmpvar_13.y) / 1024u));
      vec4 tmpvar_75;
      tmpvar_75 = texelFetchOffset (sGpuCache, tmpvar_74, 0, ivec2(0, 0));
      vec3 tmpvar_76;
      tmpvar_76.xy = mix (tmpvar_73.xy, tmpvar_73.zw, f_53);
      tmpvar_76.z = texelFetchOffset (sGpuCache, tmpvar_72, 0, ivec2(1, 0)).x;
      vec4 tmpvar_77;
      ...
      vec3 tmpvar_78;
      tmpvar_78.xy = mix (tmpvar_75.xy, tmpvar_75.zw, f_53);
      tmpvar_78.z = texelFetchOffset (sGpuCache, tmpvar_74, 0, ivec2(1, 0)).x;
      vec4 tmpvar_79;
      ...
      if ((prim_yuv_format_52 == 2)) {
        ...
        vec3 tmpvar_82;
        tmpvar_82.xy = mix (tmpvar_81.xy, tmpvar_81.zw, f_53);
        tmpvar_82.z = texelFetchOffset (sGpuCache, tmpvar_80, 0, ivec2(1, 0)).x;
        vec4 tmpvar_83;
