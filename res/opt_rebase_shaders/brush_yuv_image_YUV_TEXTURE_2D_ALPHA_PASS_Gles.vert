...
void main ()
{
  ...
  if ((prim_yuv_format_52 == 1)) {
    ...
    tmpvar_67.z = texelFetch (sGpuCache, (tmpvar_60 + ivec2(1, 0)), 0).x;
    vec4 tmpvar_68;
    ...
    tmpvar_70.z = texelFetch (sGpuCache, (tmpvar_62 + ivec2(1, 0)), 0).x;
    vec4 tmpvar_71;
    ...
    tmpvar_73.z = texelFetch (sGpuCache, (tmpvar_64 + ivec2(1, 0)), 0).x;
    vec4 tmpvar_74;
    ...
    if ((prim_yuv_format_52 == 0)) {
      ...
      tmpvar_83.z = texelFetch (sGpuCache, (tmpvar_77 + ivec2(1, 0)), 0).x;
      vec4 tmpvar_84;
      ...
      if ((prim_yuv_format_52 == 2)) {
        ...
        tmpvar_88.z = texelFetch (sGpuCache, (tmpvar_85 + ivec2(1, 0)), 0).x;
        vec4 tmpvar_89;
