...
void main ()
{
  ...
  int tmpvar_48;
  vec2 tmpvar_49;
  tmpvar_45 = tmpvar_43.xy;
  tmpvar_46 = tmpvar_43.zw;
  tmpvar_47 = tmpvar_44.x;
  tmpvar_48 = int(tmpvar_44.y);
  tmpvar_49 = tmpvar_44.zw;
  if (((tmpvar_25 & 2) != 0)) {
  ...
  flat_varying_vec4_0.xy = tmpvar_45;
  flat_varying_vec4_1.w = tmpvar_47;
  flat_varying_vec4_0.z = tmpvar_46.x;
  flat_varying_vec4_0.w = tmpvar_46.y;
  flat_varying_vec4_1.xy = tmpvar_49;
  flat_varying_highp_int_address_0 = tmpvar_12.x;
  flat_varying_vec4_1.z = float((tmpvar_48 != 0));
}
