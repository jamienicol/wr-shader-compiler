...
void opacity_brush_vs(VertexInfo vi, int prim_address, RectWithSize local_rect, RectWithSize segment_rect, ivec4 prim_user_data, int specific_resource_address, mat4 transform, PictureTask pic_task, int brush_flags, vec4 unused)
{
    ...
    vec2 _1028 = (uv / texture_size) * mix(vi.world_pos.w, 1.0, perspective_interpolate);
    varying_vec4_0 = vec4(varying_vec4_0.x, varying_vec4_0.y, _1028.x, _1028.y);
...
void main()
{
    ...
    if (transform.is_axis_aligned)
    {
        ...
        VertexInfo _915 = write_vertex(param_5, param_6, param_7, param_8, param_9);
        vi = _915;
    }
    else
    {
        ...
        VertexInfo _945 = write_transform_vertex(param_10, param_11, param_12, param_13, param_14, param_15, param_16);
        vi = _945;
    }
    ...
    opacity_brush_vs(param_17, param_18, param_19, param_20, param_21, param_22, param_23, param_24, param_25, param_26);
}
