...
void radial_gradient_brush_vs(VertexInfo vi, int prim_address, RectWithSize local_rect, RectWithSize segment_rect, ivec4 prim_user_data, int specific_resource_address, mat4 transform, PictureTask pic_task, int brush_flags, vec4 texel_rect)
{
    ...
    if ((brush_flags & 2) != 0)
    {
        vec2 _941 = (vi.local_pos - segment_rect.p0) / segment_rect.size;
        varying_vec4_0 = vec4(varying_vec4_0.x, varying_vec4_0.y, _941.x, _941.y);
        vec2 _954 = (varying_vec4_0.zw * (texel_rect.zw - texel_rect.xy)) + texel_rect.xy;
        varying_vec4_0 = vec4(varying_vec4_0.x, varying_vec4_0.y, _954.x, _954.y);
        vec2 _961 = varying_vec4_0.zw * local_rect.size;
        varying_vec4_0 = vec4(varying_vec4_0.x, varying_vec4_0.y, _961.x, _961.y);
    }
    else
    {
        vec2 _969 = vi.local_pos - local_rect.p0;
        varying_vec4_0 = vec4(varying_vec4_0.x, varying_vec4_0.y, _969.x, _969.y);
    }
...
void main()
{
    ...
    radial_gradient_brush_vs(param_20, param_21, param_22, param_23, param_24, param_25, param_26, param_27, param_28, param_29);
}
