...
ConicGradient fetch_gradient(int address)
{
    ...
    return ConicGradient(data[0].xy, data[0].z, int(data[1].x), data[1].yz);
}

void conic_gradient_brush_vs(VertexInfo vi, int prim_address, RectWithSize local_rect, RectWithSize segment_rect, ivec4 prim_user_data, int specific_resource_address, mat4 transform, PictureTask pic_task, int brush_flags, vec4 texel_rect)
{
    int param = prim_address;
    ConicGradient gradient = fetch_gradient(param);
    if ((brush_flags & 2) != 0)
    {
        vec2 _942 = (vi.local_pos - segment_rect.p0) / segment_rect.size;
        varying_vec4_0 = vec4(varying_vec4_0.x, varying_vec4_0.y, _942.x, _942.y);
        vec2 _955 = (varying_vec4_0.zw * (texel_rect.zw - texel_rect.xy)) + texel_rect.xy;
        varying_vec4_0 = vec4(varying_vec4_0.x, varying_vec4_0.y, _955.x, _955.y);
        vec2 _962 = varying_vec4_0.zw * local_rect.size;
        varying_vec4_0 = vec4(varying_vec4_0.x, varying_vec4_0.y, _962.x, _962.y);
    }
    else
    {
        vec2 _970 = vi.local_pos - local_rect.p0;
        varying_vec4_0 = vec4(varying_vec4_0.x, varying_vec4_0.y, _970.x, _970.y);
    }
    flat_varying_vec4_0 = vec4(gradient.center_point.x, gradient.center_point.y, flat_varying_vec4_0.z, flat_varying_vec4_0.w);
    flat_varying_vec4_0.z = gradient.angle;
    ...
    flat_varying_vec4_2 = vec4(tile_repeat.x, tile_repeat.y, flat_varying_vec4_2.z, flat_varying_vec4_2.w);
...
void main()
{
    ...
    if (transform.is_axis_aligned)
    {
        ...
        VertexInfo _838 = write_vertex(param_5, param_6, param_7, param_8, param_9);
        vi = _838;
    ...
    else
    {
        ...
        VertexInfo _873 = write_transform_vertex(param_11, param_12, param_13, param_14, param_15, param_16, param_17);
        vi = _873;
    }
    ...
    conic_gradient_brush_vs(param_20, param_21, param_22, param_23, param_24, param_25, param_26, param_27, param_28, param_29);
}
