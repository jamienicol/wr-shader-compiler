...
void linear_gradient_brush_vs(VertexInfo vi, int prim_address, RectWithSize local_rect, RectWithSize segment_rect, ivec4 prim_user_data, int specific_resource_address, mat4 transform, PictureTask pic_task, int brush_flags, vec4 texel_rect)
{
    ...
    if ((brush_flags & 2) != 0)
    {
        vec2 _886 = (vi.local_pos - segment_rect.p0) / segment_rect.size;
        varying_vec4_0 = vec4(varying_vec4_0.x, varying_vec4_0.y, _886.x, _886.y);
        vec2 _899 = (varying_vec4_0.zw * (texel_rect.zw - texel_rect.xy)) + texel_rect.xy;
        varying_vec4_0 = vec4(varying_vec4_0.x, varying_vec4_0.y, _899.x, _899.y);
        vec2 _906 = varying_vec4_0.zw * local_rect.size;
        varying_vec4_0 = vec4(varying_vec4_0.x, varying_vec4_0.y, _906.x, _906.y);
    }
    else
    {
        vec2 _914 = vi.local_pos - local_rect.p0;
        varying_vec4_0 = vec4(varying_vec4_0.x, varying_vec4_0.y, _914.x, _914.y);
    }
    vec2 start_point = gradient.start_end_point.xy;
    vec2 end_point = gradient.start_end_point.zw;
    vec2 dir = end_point - start_point;
    flat_varying_vec4_0 = vec4(start_point.x, start_point.y, flat_varying_vec4_0.z, flat_varying_vec4_0.w);
    vec2 _938 = dir / vec2(dot(dir, dir));
    flat_varying_vec4_0 = vec4(flat_varying_vec4_0.x, flat_varying_vec4_0.y, _938.x, _938.y);
...
void main()
{
    ...
    linear_gradient_brush_vs(param_17, param_18, param_19, param_20, param_21, param_22, param_23, param_24, param_25, param_26);
}
