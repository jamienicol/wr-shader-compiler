...
{
    ivec2 param = address;
    vec4 data = fetch_from_gpu_cache_1_direct(param);
...
vec4 untransform(vec2 ref, vec3 n, vec3 a, mat4 inv_transform)
{
    ...
    vec3 param_3 = d;
    float param_4;
    bool _285 = ray_plane(param, param_1, param_2, param_3, param_4);
    t = param_4;
    float z = p.z + (d.z * t);
...
ClipVertexInfo write_clip_tile_vertex(RectWithSize local_clip_rect, Transform prim_transform, Transform clip_transform, RectWithSize sub_rect, vec2 task_origin, vec2 screen_origin, float device_pixel_scale)
{
    ...
    vec3 _430 = pos.xyz / vec3(pos.w);
    pos = vec4(_430.x, _430.y, _430.z, pos.w);
    vec2 param = pos.xy;
...
void main()
{
    ...
    ImageMaskData mask = fetch_mask_data(param_2);
    ...
    RectWithSize param_4 = local_rect;
    ...
    ClipVertexInfo _550 = write_clip_tile_vertex(param_4, param_5, param_6, param_7, param_8, param_9, param_10);
    ClipVertexInfo vi = _550;
