...
void write_uv_rect(int resource_id, vec2 f, vec2 texture_size, inout vec3 uv, inout vec4 uv_bounds)
{
    ...
    vec2 _968 = mix(uv0, uv1, f);
    uv = vec3(_968.x, _968.y, uv.z);
    uv.z = res.layer;
    uv_bounds = vec4(uv0 + vec2(0.5), uv1 - vec2(0.5));
    vec2 _988 = uv.xy / texture_size;
    uv = vec3(_988.x, _988.y, uv.z);
...
void yuv_brush_vs(VertexInfo vi, int prim_address, RectWithSize local_rect, RectWithSize segment_rect, ivec4 prim_user_data, int specific_resource_address, mat4 transform, PictureTask pic_task, int brush_flags, vec4 unused)
{
    ...
    if (vFormat == 1)
    {
        ...
        vec2 param_2 = f;
        vec2 param_3 = vec2(textureSize(sColor0, 0));
        vec3 param_4;
        vec4 param_5;
        ...
        vec2 param_7 = f;
        vec2 param_8 = vec2(textureSize(sColor1, 0));
        vec3 param_9;
        vec4 param_10;
        ...
        vec2 param_12 = f;
        vec2 param_13 = vec2(textureSize(sColor2, 0));
        vec3 param_14;
        vec4 param_15;
    ...
    else
    {
        if (vFormat == 0)
        {
            ...
            vec2 param_17 = f;
            vec2 param_18 = vec2(textureSize(sColor0, 0));
            vec3 param_19;
            vec4 param_20;
            ...
            vec2 param_22 = f;
            vec2 param_23 = vec2(textureSize(sColor1, 0));
            vec3 param_24;
            vec4 param_25;
        ...
        else
        {
            if (vFormat == 2)
            {
                ...
                vec2 param_27 = f;
                vec2 param_28 = vec2(textureSize(sColor0, 0));
                vec3 param_29;
                vec4 param_30;
...
void main()
{
    ...
    if (transform.is_axis_aligned)
    {
        ...
        VertexInfo _886 = write_vertex(param_5, param_6, param_7, param_8, param_9);
        vi = _886;
    ...
    else
    {
        ...
        VertexInfo _921 = write_transform_vertex(param_11, param_12, param_13, param_14, param_15, param_16, param_17);
        vi = _921;
    }
    ...
    yuv_brush_vs(param_20, param_21, param_22, param_23, param_24, param_25, param_26, param_27, param_28, param_29);
}
