...
Fragment conic_gradient_brush_fs()
{
    ...
    highp vec2 current_dir = pos - flat_varying_vec4_0.xy;
    highp float current_angle = atan(current_dir.y, current_dir.x) + (1.57079637050628662109375 - flat_varying_vec4_0.z);
    highp float offset = mod(current_angle / 6.283185482025146484375, 1.0);
...
void main()
{
    Fragment frag = conic_gradient_brush_fs();
