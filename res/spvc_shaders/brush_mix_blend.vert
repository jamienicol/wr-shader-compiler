...
void mix_blend_brush_vs(VertexInfo vi, int prim_address, RectWithSize local_rect, RectWithSize segment_rect, ivec4 prim_user_data, int specific_resource_address, mat4 transform, PictureTask pic_task, int brush_flags, vec4 unused)
{
    ...
    vec2 _936 = src_uv / texture_size;
    varying_vec4_0 = vec4(_936.x, _936.y, varying_vec4_0.z, varying_vec4_0.w);
    ...
    vec2 _959 = backdrop_uv / texture_size;
    varying_vec4_1 = vec4(_959.x, _959.y, varying_vec4_1.z, varying_vec4_1.w);
...
void main()
{
    ...
    if (transform.is_axis_aligned)
    {
        ...
        VertexInfo _832 = write_vertex(param_5, param_6, param_7, param_8, param_9);
        vi = _832;
    }
    else
    {
        ...
        VertexInfo _862 = write_transform_vertex(param_10, param_11, param_12, param_13, param_14, param_15, param_16);
        vi = _862;
    }
    ...
    mix_blend_brush_vs(param_17, param_18, param_19, param_20, param_21, param_22, param_23, param_24, param_25, param_26);
}
