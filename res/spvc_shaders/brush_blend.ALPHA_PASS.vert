...
void blend_brush_vs(VertexInfo vi, int prim_address, RectWithSize local_rect, RectWithSize segment_rect, ivec4 prim_user_data, int specific_resource_address, mat4 transform, PictureTask pic_task, int brush_flags, vec4 unused)
{
    ...
    vec2 _1095 = (uv / texture_size) * mix(vi.world_pos.w, 1.0, perspective_interpolate);
    varying_vec4_0 = vec4(varying_vec4_0.x, varying_vec4_0.y, _1095.x, _1095.y);
...
void main()
{
    ...
    if (transform.is_axis_aligned)
    {
        ...
        VertexInfo _971 = write_vertex(param_5, param_6, param_7, param_8, param_9);
        vi = _971;
    ...
    else
    {
        ...
        VertexInfo _1006 = write_transform_vertex(param_11, param_12, param_13, param_14, param_15, param_16, param_17);
        vi = _1006;
    }
    ...
    blend_brush_vs(param_20, param_21, param_22, param_23, param_24, param_25, param_26, param_27, param_28, param_29);
}
