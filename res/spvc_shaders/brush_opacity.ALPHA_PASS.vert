...
void opacity_brush_vs(VertexInfo vi, int prim_address, RectWithSize local_rect, RectWithSize segment_rect, ivec4 prim_user_data, int specific_resource_address, mat4 transform, PictureTask pic_task, int brush_flags, vec4 unused)
{
    ...
    vec2 _1081 = (uv / texture_size) * mix(vi.world_pos.w, 1.0, perspective_interpolate);
    varying_vec4_0 = vec4(varying_vec4_0.x, varying_vec4_0.y, _1081.x, _1081.y);
    flat_varying_vec4_2.x = res.layer;
    flat_varying_vec4_2.y = perspective_interpolate;
    flat_varying_vec4_1 = vec4(uv0, uv1) / texture_size.xyxy;
    varying_vec4_0 = vec4(vi.local_pos.x, vi.local_pos.y, varying_vec4_0.z, varying_vec4_0.w);
    flat_varying_vec4_2.z = float(prim_user_data.y) / 65536.0;
}
...
void main()
{
    ...
    if (transform.is_axis_aligned)
    {
        ...
        VertexInfo _957 = write_vertex(param_5, param_6, param_7, param_8, param_9);
        vi = _957;
    ...
    else
    {
        ...
        VertexInfo _992 = write_transform_vertex(param_11, param_12, param_13, param_14, param_15, param_16, param_17);
        vi = _992;
    }
    ...
    opacity_brush_vs(param_20, param_21, param_22, param_23, param_24, param_25, param_26, param_27, param_28, param_29);
}
