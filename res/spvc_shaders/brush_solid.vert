...
void solid_brush_vs(VertexInfo vi, int prim_address, RectWithSize local_rect, RectWithSize segment_rect, ivec4 prim_user_data, int specific_resource_address, mat4 transform, PictureTask pic_task, int brush_flags, vec4 unused)
{
    int param = prim_address;
    SolidBrush prim = fetch_solid_primitive(param);
    float opacity = float(prim_user_data.x) / 65535.0;
    flat_varying_vec4_0 = prim.color * opacity;
}
...
void main()
{
    ...
    if (transform.is_axis_aligned)
    {
        ...
        VertexInfo _810 = write_vertex(param_5, param_6, param_7, param_8, param_9);
        vi = _810;
    }
    else
    {
        ...
        VertexInfo _840 = write_transform_vertex(param_10, param_11, param_12, param_13, param_14, param_15, param_16);
        vi = _840;
    }
    ...
    solid_brush_vs(param_17, param_18, param_19, param_20, param_21, param_22, param_23, param_24, param_25, param_26);
}
