...
void main ()
{
  ...
  tmpvar_9.x = int((2u * (uint(tmpvar_10 % 512u))));
  ...
  tmpvar_15.x = int((2u * (uint(tmpvar_10 % 512u))));
  ...
  if ((tmpvar_6 == 65535)) {
    ...
    tmpvar_19.x = int((uint(uint(tmpvar_18) % 1024u)));
