...
void main ()
{
  ...
  tmpvar_61 = int(tmpvar_60.x);
  tmpvar_62 = tmpvar_60.yz;
  if (((tmpvar_11 & 2) != 0)) {
  ...
  tmpvar_63 = (tmpvar_59.zw - tmpvar_59.xy);
  flat_varying_vec4_0.xy = tmpvar_59.xy;
  flat_varying_vec4_0.zw = (tmpvar_63 / dot (tmpvar_63, tmpvar_63));
  flat_varying_vec4_1.xy = tmpvar_62;
