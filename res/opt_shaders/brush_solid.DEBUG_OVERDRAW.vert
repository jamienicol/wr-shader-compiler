...
void main ()
{
  ...
  tmpvar_7.x = int((2u * (uint(tmpvar_8 % 512u))));
  ...
  tmpvar_13.x = int((2u * (uint(tmpvar_8 % 512u))));
  ...
  if ((tmpvar_4 == 65535)) {
    ...
    tmpvar_17.x = int((uint(uint(tmpvar_16) % 1024u)));
  ...
  tmpvar_41.x = int((uint(uint(tmpvar_14.y) % 1024u)));
