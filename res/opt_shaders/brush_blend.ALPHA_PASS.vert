...
void main ()
{
  ...
  tmpvar_18.x = int((2u * (uint(mod (tmpvar_13, 512u)))));
  ...
  tmpvar_59.x = int((uint(mod (uint(tmpvar_20.x), 1024u))));
  ...
  tmpvar_66.x = int((uint(mod (uint(address_65), 1024u))));
  ...
  if (tmpvar_74) {
    ...
    tmpvar_99.x = int((uint(mod (uint(tmpvar_20.z), 1024u))));
