...
void main ()
{
  ...
  tmpvar_49 = int(tmpvar_48.y);
  tmpvar_50 = tmpvar_48.zw;
  if (((tmpvar_9 & 2) != 0)) {
  ...
  flat_varying_vec4_0.x = tmpvar_47.x;
  flat_varying_vec4_0.zw = tmpvar_47.zw;
  varying_vec4_0.w = (varying_vec4_0.w * tmpvar_48.x);
  flat_varying_vec4_0.y = (tmpvar_47.y * tmpvar_48.x);
  flat_varying_vec4_1.x = tmpvar_50.x;
  flat_varying_vec4_1.y = (tmpvar_48.w * tmpvar_48.x);
  flat_varying_highp_int_address_0 = tmpvar_19.x;
  flat_varying_vec4_1.z = float((tmpvar_49 != 0));
}
