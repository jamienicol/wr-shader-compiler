...
void main ()
{
  ...
  if ((tmpvar_8 == 65535)) {
    ...
    tmpvar_23.x = int((uint(mod (uint(tmpvar_22), 1024u))));
  ...
  tmpvar_58.x = int((uint(mod (uint(tmpvar_20.y), 1024u))));
  ...
  tmpvar_61 = int(tmpvar_60.y);
  tmpvar_62 = tmpvar_60.zw;
  if (((tmpvar_11 & 2) != 0)) {
  ...
  flat_varying_vec4_0.x = tmpvar_59.x;
  flat_varying_vec4_0.zw = tmpvar_59.zw;
  varying_vec4_0.w = (varying_vec4_0.w * tmpvar_60.x);
  flat_varying_vec4_0.y = (tmpvar_59.y * tmpvar_60.x);
  flat_varying_vec4_1.x = tmpvar_62.x;
  flat_varying_vec4_1.y = (tmpvar_60.w * tmpvar_60.x);
  flat_varying_highp_int_address_0 = tmpvar_21.x;
  flat_varying_vec4_1.z = float((tmpvar_61 != 0));
  flat_varying_vec4_2.xy = (tmpvar_15.zw / tmpvar_60.zw);
