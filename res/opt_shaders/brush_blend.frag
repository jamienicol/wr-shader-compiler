  ...
  if (tmpvar_8) {
    ...
    for (highp int i_12 = 0; i_12 < 4; i_12++) {
      ...
      if (tmpvar_15) {
        ...
        tmpvar_20 = clamp (texelFetch (sGpuCache, tmpvar_19, 0)[(int(k_13 % 4))], 0.0, 1.0);
      ...
      if (tmpvar_15) {
        ...
        tmpvar_22.x = int((uint(uint(address_21) % 1024u)));
      ...
      if (tmpvar_15) {
        ...
        tmpvar_25.x = int((uint(uint(address_24) % 1024u)));
