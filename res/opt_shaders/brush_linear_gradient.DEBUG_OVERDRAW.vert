...
void main ()
{
  ...
  tmpvar_49 = int(tmpvar_48.x);
  tmpvar_50 = tmpvar_48.yz;
  if (((tmpvar_9 & 2) != 0)) {
  ...
  tmpvar_51 = (tmpvar_47.zw - tmpvar_47.xy);
  flat_varying_vec4_0.xy = tmpvar_47.xy;
  flat_varying_vec4_0.zw = (tmpvar_51 / dot (tmpvar_51, tmpvar_51));
