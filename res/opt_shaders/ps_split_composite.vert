...
void main ()
{
  ...
  tmpvar_2.x = int((uint(tmpvar_3 % 1024u)));
  ...
  tmpvar_18.x = int((uint(uint(tmpvar_10.x) % 1024u)));
  ...
  tmpvar_39.x = int((uint(uint(address_38) % 1024u)));
