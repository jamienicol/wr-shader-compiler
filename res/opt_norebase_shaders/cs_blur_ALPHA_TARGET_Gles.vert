...
void main ()
{
  ...
  lowp vec2 tmpvar_9;
  tmpvar_9 = vec2(textureSize (sPrevPassAlpha, 0).xy);
  vUv.z = tmpvar_8;
  vSigma = tmpvar_4.y;
  vSupport = (int(ceil(
    (1.5 * tmpvar_4.y)
  ...
  vUv.xy = mix ((tmpvar_7.xy / tmpvar_9), ((tmpvar_7.xy + tmpvar_7.zw) / tmpvar_9), aPosition);
  highp vec4 tmpvar_15;
  tmpvar_15.zw = vec2(0.0, 1.0);
  tmpvar_15.xy = (tmpvar_3.xy + (tmpvar_3.zw * aPosition));
