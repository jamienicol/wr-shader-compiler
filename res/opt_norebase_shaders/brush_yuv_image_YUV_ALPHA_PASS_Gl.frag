...
void main ()
{
  ...
  if (tmpvar_4) {
    ...
    tmpvar_6.z = vUv_Y.z;
    yuv_value_3.x = texture (sColor0, tmpvar_6).x;
    vec3 tmpvar_7;
    tmpvar_7.xy = clamp (vUv_U.xy, vUvBounds_U.xy, vUvBounds_U.zw);
    tmpvar_7.z = vUv_U.z;
    yuv_value_3.y = texture (sColor1, tmpvar_7).x;
    vec3 tmpvar_8;
    tmpvar_8.xy = clamp (vUv_V.xy, vUvBounds_V.xy, vUvBounds_V.zw);
    tmpvar_8.z = vUv_V.z;
    yuv_value_3.z = texture (sColor2, tmpvar_8).x;
    tmpvar_5 = bool(1);
  };
  ...
  if (tmpvar_4) {
    ...
    tmpvar_9.z = vUv_Y.z;
    yuv_value_3.x = texture (sColor0, tmpvar_9).x;
    vec3 tmpvar_10;
    tmpvar_10.xy = clamp (vUv_U.xy, vUvBounds_U.xy, vUvBounds_U.zw);
    tmpvar_10.z = vUv_U.z;
    yuv_value_3.yz = texture (sColor1, tmpvar_10).xy;
    tmpvar_5 = bool(1);
  };
  ...
  if (tmpvar_4) {
    ...
    tmpvar_11.z = vUv_Y.z;
    yuv_value_3 = texture (sColor0, tmpvar_11).yzx;
    tmpvar_5 = bool(1);
  };
  tmpvar_4 = bool(1);
  if (tmpvar_5) tmpvar_4 = bool(0);
  ...
  if ((vClipMaskUvBounds.xy == vClipMaskUvBounds.zw)) {
    ...
    if (!(tmpvar_22)) {
      ...
      tmpvar_18 = texelFetch (sPrevPassAlpha, tmpvar_23, 0).x;
    };
  };
