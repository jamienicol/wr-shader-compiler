...
void main ()
{
  ...
  tmpvar_67 = tmpvar_69;
  lowp vec2 tmpvar_72;
  tmpvar_72 = vec3(textureSize (sColor0, 0)).xy;
  ...
  if (((tmpvar_37 & 2) != 0)) {
    ...
    if (((tmpvar_37 & 128) != 0)) {
      highp vec2 original_stretch_size_76;
      highp vec2 segment_uv_size_77;
      highp vec2 tmpvar_78;
      tmpvar_78 = (tmpvar_74.zw - tmpvar_74.xy);
      uv0_66 = (tmpvar_74.xy + (segment_data_35.xy * tmpvar_78));
      uv1_65 = (tmpvar_74.xy + (segment_data_35.zw * tmpvar_78));
      segment_uv_size_77 = (uv1_65 - uv0_66);
      if (((tmpvar_37 & 64) != 0)) {
        segment_uv_size_77 = (uv0_66 - tmpvar_74.xy);
        stretch_size_62 = (tmpvar_33 - tmpvar_9.xy);
        if (((segment_uv_size_77.x < 0.001) || (stretch_size_62.x < 0.001))) {
          segment_uv_size_77.x = (tmpvar_74.z - uv1_65.x);
          stretch_size_62.x = (((tmpvar_9.x + tmpvar_9.z) - tmpvar_33.x) - tmpvar_34.x);
        };
        if (((segment_uv_size_77.y < 0.001) || (stretch_size_62.y < 0.001))) {
          segment_uv_size_77.y = (tmpvar_74.w - uv1_65.y);
          stretch_size_62.y = (((tmpvar_9.y + tmpvar_9.w) - tmpvar_33.y) - tmpvar_34.y);
        };
      };
      original_stretch_size_76 = stretch_size_62;
      if (((tmpvar_37 & 4) != 0)) {
        stretch_size_62.x = ((stretch_size_62.y / segment_uv_size_77.y) * segment_uv_size_77.x);
      };
      if (((tmpvar_37 & 8) != 0)) {
        stretch_size_62.y = ((original_stretch_size_76.x / segment_uv_size_77.x) * segment_uv_size_77.y);
      };
    } else {
      if (((tmpvar_37 & 4) != 0)) {
        stretch_size_62.x = (segment_data_35.z - segment_data_35.x);
      };
      if (((tmpvar_37 & 8) != 0)) {
        stretch_size_62.y = (segment_data_35.w - segment_data_35.y);
      };
    };
    if (((tmpvar_37 & 16) != 0)) {
      stretch_size_62.x = (tmpvar_34.x / max (1.0, roundEven(
        (tmpvar_34.x / stretch_size_62.x)
      )));
    };
    if (((tmpvar_37 & 32) != 0)) {
      stretch_size_62.y = (tmpvar_34.y / max (1.0, roundEven(
        (tmpvar_34.y / stretch_size_62.y)
      )));
    };
  };
  ...
  flat_varying_vec4_4.y = tmpvar_79;
  highp vec2 tmpvar_80;
  tmpvar_80 = min (uv0_66, uv1_65);
  highp vec2 tmpvar_81;
  tmpvar_81 = max (uv0_66, uv1_65);
  highp vec4 tmpvar_82;
  tmpvar_82.xy = (tmpvar_80 + vec2(0.5, 0.5));
  tmpvar_82.zw = (tmpvar_81 - vec2(0.5, 0.5));
  flat_varying_vec4_3 = (tmpvar_82 / tmpvar_72.xyxy);
  highp vec2 tmpvar_83;
  tmpvar_83 = ((tmpvar_31 - tmpvar_63) / tmpvar_64);
  f_61 = tmpvar_83;
  highp int tmpvar_84;
  tmpvar_84 = (tmpvar_15.x & 65535);
  color_mode_60 = tmpvar_84;
  highp int tmpvar_85;
  tmpvar_85 = (tmpvar_15.x >> 16);
  if ((tmpvar_84 == 0)) {
    color_mode_60 = uMode;
  };
  bool tmpvar_86;
  ...
  bool tmpvar_87;
  tmpvar_87 = bool(0);
  if ((1 == tmpvar_15.y)) tmpvar_86 = bool(1);
  if (tmpvar_87) tmpvar_86 = bool(0);
  if (tmpvar_86) {
    highp int address_88;
    address_88 = (tmpvar_5 + 2);
    highp ivec2 tmpvar_89;
    tmpvar_89.x = int((uint(address_88) % 1024u));
    tmpvar_89.y = int((uint(address_88) / 1024u));
    highp vec4 tmpvar_90;
    tmpvar_90 = mix (mix (texelFetch (sGpuCache, tmpvar_89, 0), texelFetch (sGpuCache, (tmpvar_89 + ivec2(1, 0)), 0), tmpvar_83.x), mix (texelFetch (sGpuCache, (tmpvar_89 + ivec2(2, 0)), 0), texelFetch (sGpuCache, (tmpvar_89 + ivec2(3, 0)), 0), tmpvar_83.x), tmpvar_83.y);
    f_61 = (tmpvar_90.xy / tmpvar_90.w);
    tmpvar_87 = bool(1);
  };
  tmpvar_86 = bool(1);
  if (tmpvar_87) tmpvar_86 = bool(0);
  ...
  tmpvar_91 = (tmpvar_64 / stretch_size_62);
  highp vec2 tmpvar_92;
  tmpvar_92 = mix (uv0_66, uv1_65, f_61);
  varying_vec4_0.zw = (tmpvar_92 - tmpvar_80);
  varying_vec4_0.zw = (varying_vec4_0.zw / tmpvar_72);
  varying_vec4_0.zw = (varying_vec4_0.zw * tmpvar_91);
  if ((tmpvar_79 == 0.0)) {
    varying_vec4_0.zw = (varying_vec4_0.zw * tmpvar_32.w);
  };
  highp vec4 tmpvar_93;
  tmpvar_93.xy = tmpvar_80;
  tmpvar_93.zw = tmpvar_81;
  flat_varying_vec4_2 = (tmpvar_93 / tmpvar_72.xyxy);
  flat_varying_vec4_1.zw = tmpvar_91;
  highp float tmpvar_94;
  tmpvar_94 = (float(tmpvar_15.z) / 65535.0);
  bool tmpvar_95;
  tmpvar_95 = bool(0);
  bool tmpvar_96;
  tmpvar_96 = bool(0);
  if ((0 == tmpvar_85)) tmpvar_95 = bool(1);
  if (tmpvar_96) tmpvar_95 = bool(0);
  if (tmpvar_95) {
    tmpvar_67.w = (tmpvar_69.w * tmpvar_94);
    tmpvar_96 = bool(1);
  };
  tmpvar_95 = bool(1);
  if (tmpvar_96) tmpvar_95 = bool(0);
  if (tmpvar_95) {
    tmpvar_67 = (tmpvar_67 * tmpvar_94);
    tmpvar_96 = bool(1);
  };
  bool tmpvar_97;
  tmpvar_97 = bool(0);
  bool tmpvar_98;
  tmpvar_98 = bool(0);
  if ((1 == color_mode_60)) tmpvar_97 = bool(1);
  if ((7 == color_mode_60)) tmpvar_97 = bool(1);
  if (tmpvar_98) tmpvar_97 = bool(0);
  if (tmpvar_97) {
    flat_varying_vec4_1.xy = vec2(0.0, 1.0);
    flat_varying_vec4_0 = tmpvar_67;
    tmpvar_98 = bool(1);
  };
  if ((5 == color_mode_60)) tmpvar_97 = bool(1);
  if ((6 == color_mode_60)) tmpvar_97 = bool(1);
  if ((9 == color_mode_60)) tmpvar_97 = bool(1);
  if (tmpvar_98) tmpvar_97 = bool(0);
  if (tmpvar_97) {
  ...
  if ((2 == color_mode_60)) tmpvar_97 = bool(1);
  if ((3 == color_mode_60)) tmpvar_97 = bool(1);
  if ((8 == color_mode_60)) tmpvar_97 = bool(1);
  if (tmpvar_98) tmpvar_97 = bool(0);
  if (tmpvar_97) {
    flat_varying_vec4_1.xy = vec2(1.0, 0.0);
  ...
  if ((4 == color_mode_60)) tmpvar_97 = bool(1);
  if (tmpvar_98) tmpvar_97 = bool(0);
  if (tmpvar_97) {
