...
void main ()
{
  ...
  tmpvar_63 = tmpvar_65;
  vec2 tmpvar_68;
  tmpvar_68 = vec3(textureSize (sColor0, 0)).xy;
  ivec2 tmpvar_69;
  ...
  if (((tmpvar_37 & 2) != 0)) {
    ...
    if (((tmpvar_37 & 128) != 0)) {
      vec2 tmpvar_72;
      tmpvar_72 = (tmpvar_70.zw - tmpvar_70.xy);
      uv0_62 = (tmpvar_70.xy + (segment_data_35.xy * tmpvar_72));
      uv1_61 = (tmpvar_70.xy + (segment_data_35.zw * tmpvar_72));
    };
  };
  float tmpvar_73;
  if (((tmpvar_37 & 1) != 0)) {
  ...
  vec2 tmpvar_74;
  tmpvar_74 = min (uv0_62, uv1_61);
  vec2 tmpvar_75;
  tmpvar_75 = max (uv0_62, uv1_61);
  vec4 tmpvar_76;
  tmpvar_76.xy = (tmpvar_74 + vec2(0.5, 0.5));
  tmpvar_76.zw = (tmpvar_75 - vec2(0.5, 0.5));
  flat_varying_vec4_3 = (tmpvar_76 / tmpvar_68.xyxy);
  vec2 tmpvar_77;
  ...
  varying_vec4_0.zw = (mix (uv0_62, uv1_61, f_57) - tmpvar_74);
  ...
  flat_varying_vec4_2 = (tmpvar_86 / tmpvar_68.xyxy);
