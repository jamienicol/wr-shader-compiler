...
void main ()
{
  ...
  tmpvar_50 = tmpvar_48.xy;
  tmpvar_51 = tmpvar_48.zw;
  tmpvar_52 = tmpvar_49.x;
  tmpvar_53 = int(tmpvar_49.y);
  tmpvar_54 = tmpvar_49.zw;
  if (((tmpvar_26 & 2) != 0)) {
  ...
  flat_varying_vec4_0.xy = tmpvar_50;
  flat_varying_vec4_1.w = tmpvar_52;
  flat_varying_vec4_0.z = tmpvar_51.x;
  flat_varying_vec4_0.w = tmpvar_51.y;
  flat_varying_vec4_1.xy = tmpvar_54;
  flat_varying_highp_int_address_0 = tmpvar_13.x;
  flat_varying_vec4_1.z = float((tmpvar_53 != 0));
}
