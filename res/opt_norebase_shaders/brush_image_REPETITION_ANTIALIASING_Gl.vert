...
void main ()
{
  ...
  if (((tmpvar_27 & 2) != 0)) {
    ...
    if (((tmpvar_27 & 128) != 0)) {
      vec2 original_stretch_size_55;
      vec2 segment_uv_size_56;
      vec2 tmpvar_57;
      tmpvar_57 = (tmpvar_53.zw - tmpvar_53.xy);
      uv0_48 = (tmpvar_53.xy + (segment_data_25.xy * tmpvar_57));
      uv1_47 = (tmpvar_53.xy + (segment_data_25.zw * tmpvar_57));
      segment_uv_size_56 = (uv1_47 - uv0_48);
      if (((tmpvar_27 & 64) != 0)) {
        segment_uv_size_56 = (uv0_48 - tmpvar_53.xy);
        stretch_size_44 = (tmpvar_23 - tmpvar_8.xy);
        if (((segment_uv_size_56.x < 0.001) || (stretch_size_44.x < 0.001))) {
          segment_uv_size_56.x = (tmpvar_53.z - uv1_47.x);
          stretch_size_44.x = (((tmpvar_8.x + tmpvar_8.z) - tmpvar_23.x) - tmpvar_24.x);
        };
        if (((segment_uv_size_56.y < 0.001) || (stretch_size_44.y < 0.001))) {
          segment_uv_size_56.y = (tmpvar_53.w - uv1_47.y);
          stretch_size_44.y = (((tmpvar_8.y + tmpvar_8.w) - tmpvar_23.y) - tmpvar_24.y);
        };
      };
      original_stretch_size_55 = stretch_size_44;
      if (((tmpvar_27 & 4) != 0)) {
        stretch_size_44.x = ((stretch_size_44.y / segment_uv_size_56.y) * segment_uv_size_56.x);
      };
      if (((tmpvar_27 & 8) != 0)) {
        stretch_size_44.y = ((original_stretch_size_55.x / segment_uv_size_56.x) * segment_uv_size_56.y);
      };
    } else {
      if (((tmpvar_27 & 4) != 0)) {
  ...
  vec2 tmpvar_59;
  tmpvar_59 = min (uv0_48, uv1_47);
  vec2 tmpvar_60;
  tmpvar_60 = max (uv0_48, uv1_47);
  vec4 tmpvar_61;
  tmpvar_61.xy = (tmpvar_59 + vec2(0.5, 0.5));
  tmpvar_61.zw = (tmpvar_60 - vec2(0.5, 0.5));
  flat_varying_vec4_3 = (tmpvar_61 / tmpvar_51.xyxy);
  ...
  tmpvar_62.zw = tmpvar_60;
  flat_varying_vec4_2 = (tmpvar_62 / tmpvar_51.xyxy);
}
