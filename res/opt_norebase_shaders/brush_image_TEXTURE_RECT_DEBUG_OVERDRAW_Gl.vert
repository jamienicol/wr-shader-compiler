...
void main ()
{
  ...
  if (((tmpvar_27 & 2) != 0)) {
    ...
    if (((tmpvar_27 & 128) != 0)) {
      ...
      uv0_48 = (tmpvar_52.xy + (segment_data_25.xy * tmpvar_54));
      uv1_47 = (tmpvar_52.xy + (segment_data_25.zw * tmpvar_54));
    };
  };
  float tmpvar_55;
  if (((tmpvar_27 & 1) != 0)) {
  ...
  vec4 tmpvar_57;
  tmpvar_57.xy = (tmpvar_56 + vec2(0.5, 0.5));
  tmpvar_57.zw = (max (uv0_48, uv1_47) - vec2(0.5, 0.5));
  flat_varying_vec4_3 = tmpvar_57;
  ...
  tmpvar_58.zw = vec2(textureSize (sColor0));
  flat_varying_vec4_2 = tmpvar_58;
}
