...
void main ()
{
  ...
  tmpvar_62 = tmpvar_60.xy;
  tmpvar_63 = tmpvar_60.zw;
  tmpvar_64 = tmpvar_61.x;
  tmpvar_65 = int(tmpvar_61.y);
  tmpvar_66 = tmpvar_61.zw;
  if (((tmpvar_36 & 2) != 0)) {
  ...
  flat_varying_vec4_0.xy = tmpvar_62;
  flat_varying_vec4_1.w = tmpvar_64;
  flat_varying_vec4_0.z = tmpvar_63.x;
  flat_varying_vec4_0.w = tmpvar_63.y;
  flat_varying_vec4_1.xy = tmpvar_66;
  flat_varying_highp_int_address_0 = tmpvar_14.x;
  flat_varying_vec4_1.z = float((tmpvar_65 != 0));
