...
void main ()
{
  ...
  tmpvar_62 = int(tmpvar_61.y);
  tmpvar_63 = tmpvar_61.zw;
  if (((tmpvar_36 & 2) != 0)) {
  ...
  flat_varying_vec4_0.x = tmpvar_60.x;
  flat_varying_vec4_0.zw = tmpvar_60.zw;
  varying_vec4_0.w = (varying_vec4_0.w * tmpvar_61.x);
  flat_varying_vec4_0.y = (tmpvar_60.y * tmpvar_61.x);
  flat_varying_vec4_1.x = tmpvar_63.x;
  flat_varying_vec4_1.y = (tmpvar_61.w * tmpvar_61.x);
  flat_varying_highp_int_address_0 = tmpvar_14.x;
  flat_varying_vec4_1.z = float((tmpvar_62 != 0));
  flat_varying_vec4_2.xy = (tmpvar_8.zw / tmpvar_61.zw);
