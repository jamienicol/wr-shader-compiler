...
void main ()
{
  ...
  flat_varying_vec4_0.x = tmpvar_44.x;
  flat_varying_vec4_0.zw = tmpvar_44.zw;
  varying_vec4_0.w = (varying_vec4_0.w * tmpvar_45.x);
  flat_varying_vec4_0.y = (tmpvar_44.y * tmpvar_45.x);
  flat_varying_vec4_1.x = tmpvar_47.x;
  flat_varying_vec4_1.y = (tmpvar_45.w * tmpvar_45.x);
