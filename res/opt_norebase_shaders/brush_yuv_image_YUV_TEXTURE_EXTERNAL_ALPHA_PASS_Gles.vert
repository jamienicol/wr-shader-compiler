...
void main ()
{
  ...
  if ((tmpvar_57 == 1)) {
    ...
    lowp vec2 tmpvar_73;
    tmpvar_73 = vec2(textureSize (sColor0, 0));
    lowp vec3 uv_74;
    uv_74.z = tmpvar_66;
    lowp vec4 tmpvar_75;
    ...
    lowp vec2 tmpvar_76;
    tmpvar_76 = vec2(textureSize (sColor1, 0));
    lowp vec3 uv_77;
    uv_77.z = tmpvar_69;
    lowp vec4 tmpvar_78;
    ...
    lowp vec2 tmpvar_79;
    tmpvar_79 = vec2(textureSize (sColor2, 0));
    lowp vec3 uv_80;
    uv_80.z = tmpvar_72;
    lowp vec4 tmpvar_81;
    ...
    if ((tmpvar_57 == 0)) {
      ...
      lowp vec2 tmpvar_91;
      tmpvar_91 = vec2(textureSize (sColor1, 0));
      lowp vec3 uv_92;
      uv_92.z = tmpvar_87;
      lowp vec4 tmpvar_93;
      ...
      if ((tmpvar_57 == 2)) {
        ...
        lowp vec2 tmpvar_97;
        tmpvar_97 = vec2(textureSize (sColor0, 0));
        lowp vec3 uv_98;
        uv_98.z = tmpvar_96;
        lowp vec4 tmpvar_99;
