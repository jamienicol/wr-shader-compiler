...
void main ()
{
  ...
  int tmpvar_49;
  vec2 tmpvar_50;
  tmpvar_46 = tmpvar_44.xy;
  tmpvar_47 = tmpvar_44.zw;
  tmpvar_48 = tmpvar_45.x;
  tmpvar_49 = int(tmpvar_45.y);
  tmpvar_50 = tmpvar_45.zw;
  if (((tmpvar_26 & 2) != 0)) {
  ...
  flat_varying_vec4_0.xy = tmpvar_46;
  flat_varying_vec4_1.w = tmpvar_48;
  flat_varying_vec4_0.z = tmpvar_47.x;
  flat_varying_vec4_0.w = tmpvar_47.y;
  flat_varying_vec4_1.xy = tmpvar_50;
