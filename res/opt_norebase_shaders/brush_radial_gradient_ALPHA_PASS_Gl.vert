...
void main ()
{
  ...
  flat_varying_vec4_0.x = tmpvar_56.x;
  flat_varying_vec4_0.zw = tmpvar_56.zw;
  varying_vec4_0.w = (varying_vec4_0.w * tmpvar_57.x);
  flat_varying_vec4_0.y = (tmpvar_56.y * tmpvar_57.x);
  flat_varying_vec4_1.x = tmpvar_59.x;
  flat_varying_vec4_1.y = (tmpvar_57.w * tmpvar_57.x);
