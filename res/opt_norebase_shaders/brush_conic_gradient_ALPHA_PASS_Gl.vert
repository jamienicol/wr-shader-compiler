...
void main ()
{
  ...
  int tmpvar_61;
  vec2 tmpvar_62;
  tmpvar_58 = tmpvar_56.xy;
  tmpvar_59 = tmpvar_56.zw;
  tmpvar_60 = tmpvar_57.x;
  tmpvar_61 = int(tmpvar_57.y);
  tmpvar_62 = tmpvar_57.zw;
  if (((tmpvar_36 & 2) != 0)) {
  ...
  flat_varying_vec4_0.xy = tmpvar_58;
  flat_varying_vec4_1.w = tmpvar_60;
  flat_varying_vec4_0.z = tmpvar_59.x;
  flat_varying_vec4_0.w = tmpvar_59.y;
  flat_varying_vec4_1.xy = tmpvar_62;
  flat_varying_highp_int_address_0 = tmpvar_14.x;
  flat_varying_vec4_1.z = float((tmpvar_61 != 0));
  flat_varying_vec4_2.xy = (tmpvar_8.zw / tmpvar_57.zw);
