...
void main ()
{
  ...
  tmpvar_50 = int(tmpvar_49.x);
  tmpvar_51 = tmpvar_49.yz;
  if (((tmpvar_26 & 2) != 0)) {
  ...
  tmpvar_52 = (tmpvar_48.zw - tmpvar_48.xy);
  flat_varying_vec4_0.xy = tmpvar_48.xy;
  flat_varying_vec4_0.zw = (tmpvar_52 / dot (tmpvar_52, tmpvar_52));
  flat_varying_vec4_1.xy = tmpvar_51;
