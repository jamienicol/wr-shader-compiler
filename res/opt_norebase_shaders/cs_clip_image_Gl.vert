...
void main ()
{
  ...
  tmpvar_2[0] = texelFetchOffset (sTransformPalette, tmpvar_5, 0, ivec2(0, 0));
  tmpvar_2[1] = texelFetchOffset (sTransformPalette, tmpvar_5, 0, ivec2(1, 0));
  tmpvar_2[2] = texelFetchOffset (sTransformPalette, tmpvar_5, 0, ivec2(2, 0));
  tmpvar_2[3] = texelFetchOffset (sTransformPalette, tmpvar_5, 0, ivec2(3, 0));
  tmpvar_3[0] = texelFetchOffset (sTransformPalette, tmpvar_5, 0, ivec2(4, 0));
  tmpvar_3[1] = texelFetchOffset (sTransformPalette, tmpvar_5, 0, ivec2(5, 0));
  tmpvar_3[2] = texelFetchOffset (sTransformPalette, tmpvar_5, 0, ivec2(6, 0));
  tmpvar_3[3] = texelFetchOffset (sTransformPalette, tmpvar_5, 0, ivec2(7, 0));
  mat4 tmpvar_6;
  int tmpvar_7;
  ...
  tmpvar_6[0] = texelFetchOffset (sTransformPalette, tmpvar_8, 0, ivec2(0, 0));
  tmpvar_6[1] = texelFetchOffset (sTransformPalette, tmpvar_8, 0, ivec2(1, 0));
  tmpvar_6[2] = texelFetchOffset (sTransformPalette, tmpvar_8, 0, ivec2(2, 0));
  tmpvar_6[3] = texelFetchOffset (sTransformPalette, tmpvar_8, 0, ivec2(3, 0));
  vec2 tmpvar_9;
  vec2 tmpvar_10;
  vec4 tmpvar_11;
