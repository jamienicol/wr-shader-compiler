...
void main ()
{
  ...
  if ((tmpvar_44 == 1)) {
    ...
    lowp vec2 tmpvar_60;
    tmpvar_60 = vec2(textureSize (sColor0, 0).xy);
    lowp vec3 uv_61;
    uv_61.z = tmpvar_53;
    lowp vec4 tmpvar_62;
    ...
    lowp vec2 tmpvar_63;
    tmpvar_63 = vec2(textureSize (sColor1, 0).xy);
    lowp vec3 uv_64;
    uv_64.z = tmpvar_56;
    lowp vec4 tmpvar_65;
    ...
    lowp vec2 tmpvar_66;
    tmpvar_66 = vec2(textureSize (sColor2, 0).xy);
    lowp vec3 uv_67;
    uv_67.z = tmpvar_59;
    lowp vec4 tmpvar_68;
    ...
    if ((tmpvar_44 == 0)) {
      ...
      lowp vec2 tmpvar_75;
      tmpvar_75 = vec2(textureSize (sColor0, 0).xy);
      lowp vec3 uv_76;
      uv_76.z = tmpvar_71;
      lowp vec4 tmpvar_77;
      ...
      lowp vec2 tmpvar_78;
      tmpvar_78 = vec2(textureSize (sColor1, 0).xy);
      lowp vec3 uv_79;
      uv_79.z = tmpvar_74;
      lowp vec4 tmpvar_80;
      ...
      if ((tmpvar_44 == 2)) {
        ...
        lowp vec2 tmpvar_84;
        tmpvar_84 = vec2(textureSize (sColor0, 0).xy);
        lowp vec3 uv_85;
        uv_85.z = tmpvar_83;
        lowp vec4 tmpvar_86;
