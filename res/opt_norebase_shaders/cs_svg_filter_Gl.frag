...
void main ()
{
  ...
  if (tmpvar_9) {
    ...
    for (int i_151 = 0; i_151 < 4; i_151++) {
      ...
      if (tmpvar_154) {
        ...
        colora_150[i_151] = clamp (texelFetch (sGpuCache, (vData.xy + tmpvar_157), 0)[(k_152 % 4)], 0.0, 1.0);
        offset_153 += 64;
        tmpvar_155 = bool(1);
      };
      ...
      if (tmpvar_154) {
        ivec2 tmpvar_158;
        tmpvar_158.y = 0;
        tmpvar_158.x = offset_153;
        vec4 tmpvar_159;
        tmpvar_159 = texelFetch (sGpuCache, (vData.xy + tmpvar_158), 0);
        colora_150[i_151] = clamp (((tmpvar_159.x * 
          colora_150[i_151]
        ) + tmpvar_159.y), 0.0, 1.0);
        offset_153++;
        tmpvar_155 = bool(1);
      };
      ...
      if (tmpvar_154) {
        ...
        colora_150[i_151] = clamp (((tmpvar_161.x * 
          pow (colora_150[i_151], tmpvar_161.y)
        ) + tmpvar_161.z), 0.0, 1.0);
        offset_153++;
        tmpvar_155 = bool(1);
      };
      tmpvar_154 = bool(1);
  ...
  if (tmpvar_9) {
    vec4 Cr_162;
    Cr_162 = vec4(0.0, 1.0, 0.0, 1.0);
    bool tmpvar_163;
    tmpvar_163 = bool(0);
    bool tmpvar_164;
    tmpvar_164 = bool(0);
    if ((0 == vData.x)) tmpvar_163 = bool(1);
    if (tmpvar_164) tmpvar_163 = bool(0);
    if (tmpvar_163) {
      Cr_162.xyz = ((Ca_4.w * Ca_4.xyz) + ((Cb_3.w * Cb_3.xyz) * (1.0 - Ca_4.w)));
      Cr_162.w = (Ca_4.w + (Cb_3.w * (1.0 - Ca_4.w)));
      tmpvar_164 = bool(1);
    };
    if ((1 == vData.x)) tmpvar_163 = bool(1);
    if (tmpvar_164) tmpvar_163 = bool(0);
    if (tmpvar_163) {
      Cr_162.xyz = ((Ca_4.w * Ca_4.xyz) * Cb_3.w);
      Cr_162.w = (Ca_4.w * Cb_3.w);
      tmpvar_164 = bool(1);
    };
    if ((2 == vData.x)) tmpvar_163 = bool(1);
    if (tmpvar_164) tmpvar_163 = bool(0);
    if (tmpvar_163) {
      Cr_162.xyz = ((Ca_4.w * Ca_4.xyz) * (1.0 - Cb_3.w));
      Cr_162.w = (Ca_4.w * (1.0 - Cb_3.w));
      tmpvar_164 = bool(1);
    };
    if ((3 == vData.x)) tmpvar_163 = bool(1);
    if (tmpvar_164) tmpvar_163 = bool(0);
    if (tmpvar_163) {
      Cr_162.xyz = (((Ca_4.w * Ca_4.xyz) * Cb_3.w) + ((Cb_3.w * Cb_3.xyz) * (1.0 - Ca_4.w)));
      Cr_162.w = ((Ca_4.w * Cb_3.w) + (Cb_3.w * (1.0 - Ca_4.w)));
      tmpvar_164 = bool(1);
    };
    if ((4 == vData.x)) tmpvar_163 = bool(1);
    if (tmpvar_164) tmpvar_163 = bool(0);
    if (tmpvar_163) {
      Cr_162.xyz = (((Ca_4.w * Ca_4.xyz) * (1.0 - Cb_3.w)) + ((Cb_3.w * Cb_3.xyz) * (1.0 - Ca_4.w)));
      Cr_162.w = ((Ca_4.w * (1.0 - Cb_3.w)) + (Cb_3.w * (1.0 - Ca_4.w)));
      tmpvar_164 = bool(1);
    };
    if ((5 == vData.x)) tmpvar_163 = bool(1);
    if (tmpvar_164) tmpvar_163 = bool(0);
    if (tmpvar_163) {
      Cr_162.xyz = ((Ca_4.w * Ca_4.xyz) + (Cb_3.w * Cb_3.xyz));
      Cr_162.w = (Ca_4.w + Cb_3.w);
      Cr_162 = clamp (Cr_162, vec4(0.0, 0.0, 0.0, 0.0), vec4(1.0, 1.0, 1.0, 1.0));
      tmpvar_164 = bool(1);
    };
    if ((6 == vData.x)) tmpvar_163 = bool(1);
    if (tmpvar_164) tmpvar_163 = bool(0);
    if (tmpvar_163) {
      Cr_162 = (((
