...
void main ()
{
  ...
  if (((tmpvar_27 & 2) != 0)) {
    ...
    if (((tmpvar_27 & 128) != 0)) {
      ...
      tmpvar_59 = (tmpvar_57.zw - tmpvar_57.xy);
      uv0_52 = (tmpvar_57.xy + (segment_data_25.xy * tmpvar_59));
      uv1_51 = (tmpvar_57.xy + (segment_data_25.zw * tmpvar_59));
    };
  };
  ...
  flat_varying_vec4_4.y = tmpvar_60;
  highp vec2 tmpvar_61;
  tmpvar_61 = min (uv0_52, uv1_51);
  highp vec2 tmpvar_62;
  tmpvar_62 = max (uv0_52, uv1_51);
  highp vec4 tmpvar_63;
  tmpvar_63.xy = (tmpvar_61 + vec2(0.5, 0.5));
  tmpvar_63.zw = (tmpvar_62 - vec2(0.5, 0.5));
  flat_varying_vec4_3 = (tmpvar_63 / tmpvar_55.xyxy);
  lowp vec2 tmpvar_64;
  tmpvar_64 = ((tmpvar_21 - tmpvar_49) / tmpvar_50);
  highp vec2 tmpvar_65;
  tmpvar_65 = mix (uv0_52, uv1_51, tmpvar_64);
  varying_vec4_0.zw = (tmpvar_65 - tmpvar_61);
  varying_vec4_0.zw = (varying_vec4_0.zw / tmpvar_55);
  varying_vec4_0.zw = (varying_vec4_0.zw * (tmpvar_50 / stretch_size_48));
  if ((tmpvar_60 == 0.0)) {
    varying_vec4_0.zw = (varying_vec4_0.zw * tmpvar_22.w);
  };
  highp vec4 tmpvar_66;
  tmpvar_66.xy = tmpvar_61;
  tmpvar_66.zw = tmpvar_62;
  flat_varying_vec4_2 = (tmpvar_66 / tmpvar_55.xyxy);
}
