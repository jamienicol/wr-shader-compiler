...
void main ()
{
  ...
  highp int tmpvar_57;
  lowp vec2 f_58;
  f_58 = ((tmpvar_30 - tmpvar_8.xy) / tmpvar_8.zw);
  ...
  tmpvar_57 = int(tmpvar_60.z);
  vCoefficient = tmpvar_60.x;
  highp int color_space_61;
  color_space_61 = int(tmpvar_60.y);
  mat3 tmpvar_62;
  bool tmpvar_63;
  tmpvar_63 = bool(0);
  if ((0 == color_space_61)) tmpvar_63 = bool(1);
  if (tmpvar_63) {
    tmpvar_62 = mat3(1.16438, 1.16438, 1.16438, 0.0, -0.39176, 2.01723, 1.59603, -0.81297, 0.0);
  } else {
    if ((1 == color_space_61)) tmpvar_63 = bool(1);
    if (tmpvar_63) {
      tmpvar_62 = mat3(1.16438, 1.16438, 1.16438, 0.0, -0.21325, 2.1124, 1.79274, -0.53291, 0.0);
    } else {
      tmpvar_63 = bool(1);
      tmpvar_62 = mat3(1.164384, 1.164384, 1.164384, 0.0, -0.1873261, 2.141772, 1.678674, -0.6504243, 0.0);
    };
  };
  vYuvColorMatrix = tmpvar_62;
  vFormat = tmpvar_57;
  vLocalPos = tmpvar_30;
  if ((tmpvar_57 == 1)) {
    highp ivec2 tmpvar_64;
    tmpvar_64.x = int((uint(tmpvar_14.x) % 1024u));
    tmpvar_64.y = int((uint(tmpvar_14.x) / 1024u));
    ...
    tmpvar_67.x = int((uint(tmpvar_14.y) % 1024u));
    tmpvar_67.y = int((uint(tmpvar_14.y) / 1024u));
    highp vec4 tmpvar_68;
    tmpvar_68 = texelFetch (sGpuCache, tmpvar_67, 0);
    highp float tmpvar_69;
    tmpvar_69 = texelFetch (sGpuCache, (tmpvar_67 + ivec2(1, 0)), 0).x;
    highp ivec2 tmpvar_70;
    tmpvar_70.x = int((uint(tmpvar_14.z) % 1024u));
    tmpvar_70.y = int((uint(tmpvar_14.z) / 1024u));
    highp vec4 tmpvar_71;
    tmpvar_71 = texelFetch (sGpuCache, tmpvar_70, 0);
    highp float tmpvar_72;
    tmpvar_72 = texelFetch (sGpuCache, (tmpvar_70 + ivec2(1, 0)), 0).x;
    lowp vec2 tmpvar_73;
    tmpvar_73 = vec2(textureSize (sColor0, 0).xy);
    lowp vec3 uv_74;
    uv_74.z = tmpvar_66;
    lowp vec4 tmpvar_75;
    tmpvar_75.xy = (tmpvar_65.xy + vec2(0.5, 0.5));
    tmpvar_75.zw = (tmpvar_65.zw - vec2(0.5, 0.5));
    uv_74.xy = (mix (tmpvar_65.xy, tmpvar_65.zw, f_58) / tmpvar_73);
    vUv_Y = uv_74;
    vUvBounds_Y = (tmpvar_75 / tmpvar_73.xyxy);
    lowp vec2 tmpvar_76;
    tmpvar_76 = vec2(textureSize (sColor1, 0).xy);
    lowp vec3 uv_77;
    uv_77.z = tmpvar_69;
    lowp vec4 tmpvar_78;
    tmpvar_78.xy = (tmpvar_68.xy + vec2(0.5, 0.5));
    tmpvar_78.zw = (tmpvar_68.zw - vec2(0.5, 0.5));
    uv_77.xy = (mix (tmpvar_68.xy, tmpvar_68.zw, f_58) / tmpvar_76);
    vUv_U = uv_77;
    vUvBounds_U = (tmpvar_78 / tmpvar_76.xyxy);
    lowp vec2 tmpvar_79;
    tmpvar_79 = vec2(textureSize (sColor2, 0).xy);
    lowp vec3 uv_80;
    uv_80.z = tmpvar_72;
    lowp vec4 tmpvar_81;
    tmpvar_81.xy = (tmpvar_71.xy + vec2(0.5, 0.5));
    tmpvar_81.zw = (tmpvar_71.zw - vec2(0.5, 0.5));
    uv_80.xy = (mix (tmpvar_71.xy, tmpvar_71.zw, f_58) / tmpvar_79);
    vUv_V = uv_80;
    vUvBounds_V = (tmpvar_81 / tmpvar_79.xyxy);
  } else {
    if ((tmpvar_57 == 0)) {
      highp ivec2 tmpvar_82;
      tmpvar_82.x = int((uint(tmpvar_14.x) % 1024u));
      tmpvar_82.y = int((uint(tmpvar_14.x) / 1024u));
      highp vec4 tmpvar_83;
      tmpvar_83 = texelFetch (sGpuCache, tmpvar_82, 0);
      highp float tmpvar_84;
      tmpvar_84 = texelFetch (sGpuCache, (tmpvar_82 + ivec2(1, 0)), 0).x;
      highp ivec2 tmpvar_85;
      tmpvar_85.x = int((uint(tmpvar_14.y) % 1024u));
      tmpvar_85.y = int((uint(tmpvar_14.y) / 1024u));
      highp vec4 tmpvar_86;
      tmpvar_86 = texelFetch (sGpuCache, tmpvar_85, 0);
      highp float tmpvar_87;
      tmpvar_87 = texelFetch (sGpuCache, (tmpvar_85 + ivec2(1, 0)), 0).x;
      lowp vec2 tmpvar_88;
      tmpvar_88 = vec2(textureSize (sColor0, 0).xy);
      lowp vec3 uv_89;
      uv_89.z = tmpvar_84;
      lowp vec4 tmpvar_90;
      tmpvar_90.xy = (tmpvar_83.xy + vec2(0.5, 0.5));
      tmpvar_90.zw = (tmpvar_83.zw - vec2(0.5, 0.5));
      uv_89.xy = (mix (tmpvar_83.xy, tmpvar_83.zw, f_58) / tmpvar_88);
      vUv_Y = uv_89;
      vUvBounds_Y = (tmpvar_90 / tmpvar_88.xyxy);
      lowp vec2 tmpvar_91;
      tmpvar_91 = vec2(textureSize (sColor1, 0).xy);
      lowp vec3 uv_92;
      uv_92.z = tmpvar_87;
      lowp vec4 tmpvar_93;
      tmpvar_93.xy = (tmpvar_86.xy + vec2(0.5, 0.5));
      tmpvar_93.zw = (tmpvar_86.zw - vec2(0.5, 0.5));
      uv_92.xy = (mix (tmpvar_86.xy, tmpvar_86.zw, f_58) / tmpvar_91);
      vUv_U = uv_92;
      vUvBounds_U = (tmpvar_93 / tmpvar_91.xyxy);
    } else {
      if ((tmpvar_57 == 2)) {
        highp ivec2 tmpvar_94;
        tmpvar_94.x = int((uint(tmpvar_14.x) % 1024u));
        tmpvar_94.y = int((uint(tmpvar_14.x) / 1024u));
        highp vec4 tmpvar_95;
        tmpvar_95 = texelFetch (sGpuCache, tmpvar_94, 0);
        highp float tmpvar_96;
        tmpvar_96 = texelFetch (sGpuCache, (tmpvar_94 + ivec2(1, 0)), 0).x;
        lowp vec2 tmpvar_97;
        tmpvar_97 = vec2(textureSize (sColor0, 0).xy);
        lowp vec3 uv_98;
        uv_98.z = tmpvar_96;
        lowp vec4 tmpvar_99;
        tmpvar_99.xy = (tmpvar_95.xy + vec2(0.5, 0.5));
        tmpvar_99.zw = (tmpvar_95.zw - vec2(0.5, 0.5));
        uv_98.xy = (mix (tmpvar_95.xy, tmpvar_95.zw, f_58) / tmpvar_97);
        vUv_Y = uv_98;
        vUvBounds_Y = (tmpvar_99 / tmpvar_97.xyxy);
      };
    };
  };
}
