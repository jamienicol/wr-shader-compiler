...
void main ()
{
  ...
  color_2 = mix (texelFetchOffset (sGpuCache, tmpvar_13, 0, ivec2(0, 0)), texelFetchOffset (sGpuCache, tmpvar_13, 0, ivec2(1, 0)), fract(x_11));
  vec2 tmpvar_14;
  ...
  if ((vClipMaskUvBounds.xy == vClipMaskUvBounds.zw)) {
    ...
    if (!(tmpvar_23)) {
      ...
      tmpvar_19 = texelFetch (sPrevPassAlpha, tmpvar_24, 0).x;
    };
  };
