...
void main ()
{
  ...
  int tmpvar_60;
  vec2 tmpvar_61;
  tmpvar_57 = tmpvar_55.xy;
  tmpvar_58 = tmpvar_55.zw;
  tmpvar_59 = tmpvar_56.x;
  tmpvar_60 = int(tmpvar_56.y);
  tmpvar_61 = tmpvar_56.zw;
  if (((tmpvar_35 & 2) != 0)) {
  ...
  flat_varying_vec4_0.xy = tmpvar_57;
  flat_varying_vec4_1.w = tmpvar_59;
  flat_varying_vec4_0.z = tmpvar_58.x;
  flat_varying_vec4_0.w = tmpvar_58.y;
  flat_varying_vec4_1.xy = tmpvar_61;
  flat_varying_highp_int_address_0 = tmpvar_13.x;
  flat_varying_vec4_1.z = float((tmpvar_60 != 0));
