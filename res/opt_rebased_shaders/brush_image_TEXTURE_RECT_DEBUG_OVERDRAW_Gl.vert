...
void main ()
{
  ...
  if (((tmpvar_26 & 2) != 0)) {
    ...
    if (((tmpvar_26 & 128) != 0)) {
      ...
      uv0_47 = (tmpvar_51.xy + (segment_data_24.xy * tmpvar_53));
      uv1_46 = (tmpvar_51.xy + (segment_data_24.zw * tmpvar_53));
    };
  };
  float tmpvar_54;
  if (((tmpvar_26 & 1) != 0)) {
  ...
  vec4 tmpvar_56;
  tmpvar_56.xy = (tmpvar_55 + vec2(0.5, 0.5));
  tmpvar_56.zw = (max (uv0_47, uv1_46) - vec2(0.5, 0.5));
  flat_varying_vec4_3 = tmpvar_56;
  varying_vec4_0.zw = (mix (uv0_47, uv1_46, (
    (vi_local_pos_20 - local_rect_p0_44)
   / local_rect_size_45)) - tmpvar_55);
  ...
  vec4 tmpvar_57;
  tmpvar_57.xy = vec2(0.0, 0.0);
  tmpvar_57.zw = vec2(textureSize (sColor0));
  flat_varying_vec4_2 = tmpvar_57;
}
