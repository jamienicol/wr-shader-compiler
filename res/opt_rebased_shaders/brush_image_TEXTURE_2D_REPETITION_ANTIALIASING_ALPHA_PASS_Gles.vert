...
void main ()
{
  ...
  if (((tmpvar_36 & 2) != 0)) {
    ...
    if (((tmpvar_36 & 128) != 0)) {
      highp vec2 original_stretch_size_70;
      highp vec2 segment_uv_size_71;
      vec2 tmpvar_72;
  ...
  while (true) {
    ...
    if (tmpvar_79) {
      ...
      vec4 tmpvar_82;
      tmpvar_82 = mix (mix (texelFetch (sGpuCache, tmpvar_81, 0), texelFetch (sGpuCache, (tmpvar_81 + ivec2(1, 0)), 0), f_56.x), mix (texelFetch (sGpuCache, (tmpvar_81 + ivec2(2, 0)), 0), texelFetch (sGpuCache, (tmpvar_81 + ivec2(3, 0)), 0), f_56.x), f_56.y);
