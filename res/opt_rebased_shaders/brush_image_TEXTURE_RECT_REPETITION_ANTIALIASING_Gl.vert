...
void main ()
{
  ...
  float tmpvar_52;
  tmpvar_52 = texelFetchOffset (sGpuCache, tmpvar_50, 0, ivec2(1, 0)).x;
  uv0_47 = tmpvar_51.xy;
  uv1_46 = tmpvar_51.zw;
  ...
  if (((tmpvar_26 & 2) != 0)) {
    ...
    if (((tmpvar_26 & 128) != 0)) {
      vec2 original_stretch_size_53;
      vec2 segment_uv_size_54;
      vec2 tmpvar_55;
      tmpvar_55 = (tmpvar_51.zw - tmpvar_51.xy);
      uv0_47 = (tmpvar_51.xy + (segment_data_24.xy * tmpvar_55));
      uv1_46 = (tmpvar_51.xy + (segment_data_24.zw * tmpvar_55));
      segment_uv_size_54 = (uv1_46 - uv0_47);
      if (((tmpvar_26 & 64) != 0)) {
        segment_uv_size_54 = (uv0_47 - tmpvar_51.xy);
        stretch_size_43 = (segment_rect_p0_22 - tmpvar_7.xy);
        if (((segment_uv_size_54.x < 0.001) || (stretch_size_43.x < 0.001))) {
          segment_uv_size_54.x = (tmpvar_51.z - uv1_46.x);
          stretch_size_43.x = (((tmpvar_7.x + tmpvar_7.z) - segment_rect_p0_22.x) - segment_rect_size_23.x);
        };
        if (((segment_uv_size_54.y < 0.001) || (stretch_size_43.y < 0.001))) {
          segment_uv_size_54.y = (tmpvar_51.w - uv1_46.y);
          stretch_size_43.y = (((tmpvar_7.y + tmpvar_7.w) - segment_rect_p0_22.y) - segment_rect_size_23.y);
        };
      };
      original_stretch_size_53 = stretch_size_43;
      if (((tmpvar_26 & 4) != 0)) {
        stretch_size_43.x = ((stretch_size_43.y / segment_uv_size_54.y) * segment_uv_size_54.x);
      };
      if (((tmpvar_26 & 8) != 0)) {
        stretch_size_43.y = ((original_stretch_size_53.x / segment_uv_size_54.x) * segment_uv_size_54.y);
      };
    } else {
      if (((tmpvar_26 & 4) != 0)) {
  ...
  flat_varying_vec4_4.x = tmpvar_52;
  flat_varying_vec4_4.y = tmpvar_56;
  vec2 tmpvar_57;
  tmpvar_57 = min (uv0_47, uv1_46);
  vec4 tmpvar_58;
  tmpvar_58.xy = (tmpvar_57 + vec2(0.5, 0.5));
  tmpvar_58.zw = (max (uv0_47, uv1_46) - vec2(0.5, 0.5));
  flat_varying_vec4_3 = tmpvar_58;
  varying_vec4_0.zw = (mix (uv0_47, uv1_46, (
    (vi_local_pos_20 - local_rect_p0_44)
   / local_rect_size_45)) - tmpvar_57);
  ...
  tmpvar_59.zw = vec2(textureSize (sColor0));
  flat_varying_vec4_2 = tmpvar_59;
}
