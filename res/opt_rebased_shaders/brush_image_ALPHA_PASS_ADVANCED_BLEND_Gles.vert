...
void main ()
{
  ...
  highp int color_mode_55;
  highp vec2 f_56;
  highp vec2 stretch_size_57;
  ...
  vec4 tmpvar_64;
  vec4 tmpvar_65;
  tmpvar_64 = texelFetch (sGpuCache, (tmpvar_63 + ivec2(1, 0)), 0);
  tmpvar_65 = texelFetch (sGpuCache, (tmpvar_63 + ivec2(2, 0)), 0);
  image_data_color_62 = texelFetch (sGpuCache, tmpvar_63, 0);
  vec2 tmpvar_66;
  ...
  float tmpvar_69;
  tmpvar_69 = texelFetch (sGpuCache, (tmpvar_67 + ivec2(1, 0)), 0).x;
  uv0_61 = tmpvar_68.xy;
  uv1_60 = tmpvar_68.zw;
  ...
  if (((tmpvar_36 & 2) != 0)) {
    ...
    if (((tmpvar_36 & 128) != 0)) {
      vec2 tmpvar_70;
      tmpvar_70 = (tmpvar_68.zw - tmpvar_68.xy);
      uv0_61 = (tmpvar_68.xy + (segment_data_34.xy * tmpvar_70));
      uv1_60 = (tmpvar_68.xy + (segment_data_34.zw * tmpvar_70));
    };
  };
  float tmpvar_71;
  if (((tmpvar_36 & 1) != 0)) {
  ...
  flat_varying_vec4_4.y = tmpvar_71;
  vec2 tmpvar_72;
  tmpvar_72 = min (uv0_61, uv1_60);
  vec2 tmpvar_73;
  tmpvar_73 = max (uv0_61, uv1_60);
  vec4 tmpvar_74;
  tmpvar_74.xy = (tmpvar_72 + vec2(0.5, 0.5));
  tmpvar_74.zw = (tmpvar_73 - vec2(0.5, 0.5));
  flat_varying_vec4_3 = (tmpvar_74 / tmpvar_66.xyxy);
  ...
  while (true) {
    ...
    if (tmpvar_77) {
      ...
      vec4 tmpvar_80;
      tmpvar_80 = mix (mix (texelFetch (sGpuCache, tmpvar_79, 0), texelFetch (sGpuCache, (tmpvar_79 + ivec2(1, 0)), 0), f_56.x), mix (texelFetch (sGpuCache, (tmpvar_79 + ivec2(2, 0)), 0), texelFetch (sGpuCache, (tmpvar_79 + ivec2(3, 0)), 0), f_56.x), f_56.y);
  ...
  varying_vec4_0.zw = (mix (uv0_61, uv1_60, f_56) - tmpvar_72);
  ...
  vec4 tmpvar_82;
  tmpvar_82.xy = tmpvar_72;
  tmpvar_82.zw = tmpvar_73;
  flat_varying_vec4_2 = (tmpvar_82 / tmpvar_66.xyxy);
