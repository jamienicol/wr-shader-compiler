...
void main ()
{
  ...
  while (true) {
    ...
    if (tmpvar_68) {
      ...
      mat4 tmpvar_91;
      tmpvar_91[uint(0)] = texelFetch (sGpuCache, tmpvar_88, 0);
      tmpvar_91[1u] = texelFetch (sGpuCache, (tmpvar_88 + ivec2(1, 0)), 0);
      tmpvar_91[2u] = texelFetch (sGpuCache, (tmpvar_88 + ivec2(2, 0)), 0);
      tmpvar_91[3u] = texelFetch (sGpuCache, (tmpvar_88 + ivec2(3, 0)), 0);
      vColorMat = tmpvar_91;
