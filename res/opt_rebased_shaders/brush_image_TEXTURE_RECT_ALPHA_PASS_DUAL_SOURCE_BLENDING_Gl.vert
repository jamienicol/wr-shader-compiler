...
void main ()
{
  ...
  if (((tmpvar_36 & 2) != 0)) {
    ...
    if (((tmpvar_36 & 128) != 0)) {
      vec2 tmpvar_69;
      tmpvar_69 = (tmpvar_67.zw - tmpvar_67.xy);
      uv0_61 = (tmpvar_67.xy + (segment_data_34.xy * tmpvar_69));
      uv1_60 = (tmpvar_67.xy + (segment_data_34.zw * tmpvar_69));
    };
  };
  float tmpvar_70;
  if (((tmpvar_36 & 1) != 0)) {
  ...
  vec2 tmpvar_71;
  tmpvar_71 = min (uv0_61, uv1_60);
  vec4 tmpvar_72;
  tmpvar_72.xy = (tmpvar_71 + vec2(0.5, 0.5));
  tmpvar_72.zw = (max (uv0_61, uv1_60) - vec2(0.5, 0.5));
  flat_varying_vec4_3 = tmpvar_72;
  f_56 = ((vi_local_pos_30 - local_rect_p0_58) / local_rect_size_59);
  int tmpvar_73;
  tmpvar_73 = (tmpvar_14.x & 65535);
  color_mode_55 = tmpvar_73;
  int tmpvar_74;
  ...
  tmpvar_75 = bool(0);
  while (true) {
    tmpvar_75 = (tmpvar_75 || (1 == tmpvar_14.y));
    if (tmpvar_75) {
      int tmpvar_76;
      tmpvar_76 = (instance_resource_address_5 + 2);
      ivec2 tmpvar_77;
      tmpvar_77.x = int((uint(tmpvar_76) % 1024u));
      tmpvar_77.y = int((uint(tmpvar_76) / 1024u));
      vec4 tmpvar_78;
      tmpvar_78 = mix (mix (texelFetchOffset (sGpuCache, tmpvar_77, 0, ivec2(0, 0)), texelFetchOffset (sGpuCache, tmpvar_77, 0, ivec2(1, 0)), f_56.x), mix (texelFetchOffset (sGpuCache, tmpvar_77, 0, ivec2(2, 0)), texelFetchOffset (sGpuCache, tmpvar_77, 0, ivec2(3, 0)), f_56.x), f_56.y);
      f_56 = (tmpvar_78.xy / tmpvar_78.w);
      break;
    };
    tmpvar_75 = bool(1);
    break;
  ...
  vec2 tmpvar_79;
  tmpvar_79 = (local_rect_size_59 / stretch_size_57);
  varying_vec4_0.zw = (mix (uv0_61, uv1_60, f_56) - tmpvar_71);
  varying_vec4_0.zw = varying_vec4_0.zw;
  varying_vec4_0.zw = (varying_vec4_0.zw * tmpvar_79);
  if ((tmpvar_70 == 0.0)) {
    varying_vec4_0.zw = (varying_vec4_0.zw * vi_world_pos_31.w);
  };
  vec4 tmpvar_80;
  tmpvar_80.xy = vec2(0.0, 0.0);
  tmpvar_80.zw = vec2(textureSize (sColor0));
  flat_varying_vec4_2 = tmpvar_80;
  flat_varying_vec4_1.zw = tmpvar_79;
  float tmpvar_81;
  tmpvar_81 = (float(tmpvar_14.z) / 65535.0);
  bool tmpvar_82;
  tmpvar_82 = bool(0);
  while (true) {
    tmpvar_82 = (tmpvar_82 || (0 == tmpvar_74));
    if (tmpvar_82) {
      image_data_color_62.w = (image_data_color_62.w * tmpvar_81);
      break;
    };
    tmpvar_82 = bool(1);
    image_data_color_62 = (image_data_color_62 * tmpvar_81);
    break;
  };
  bool tmpvar_83;
  tmpvar_83 = bool(0);
  while (true) {
    tmpvar_83 = (tmpvar_83 || (1 == color_mode_55));
    tmpvar_83 = (tmpvar_83 || (7 == color_mode_55));
    if (tmpvar_83) {
      flat_varying_vec4_1.xy = vec2(0.0, 1.0);
      flat_varying_vec4_0 = image_data_color_62;
      break;
    };
    tmpvar_83 = (tmpvar_83 || (5 == color_mode_55));
    tmpvar_83 = (tmpvar_83 || (6 == color_mode_55));
    tmpvar_83 = (tmpvar_83 || (9 == color_mode_55));
    if (tmpvar_83) {
      flat_varying_vec4_1.xy = vec2(1.0, 0.0);
      flat_varying_vec4_0 = image_data_color_62;
      break;
    };
    tmpvar_83 = (tmpvar_83 || (2 == color_mode_55));
    tmpvar_83 = (tmpvar_83 || (3 == color_mode_55));
    tmpvar_83 = (tmpvar_83 || (8 == color_mode_55));
    if (tmpvar_83) {
      flat_varying_vec4_1.xy = vec2(1.0, 0.0);
      flat_varying_vec4_0 = image_data_color_62.wwww;
      break;
    };
    tmpvar_83 = (tmpvar_83 || (4 == color_mode_55));
    if (tmpvar_83) {
