...
void main ()
{
  ...
  float tmpvar_17;
  tmpvar_17 = texelFetch (sGpuCache, (tmpvar_15 + ivec2(1, 0)), 0).x;
  ...
  vec4 tmpvar_37;
  tmpvar_37 = mix (mix (texelFetch (sGpuCache, tmpvar_36, 0), texelFetch (sGpuCache, (tmpvar_36 + ivec2(1, 0)), 0), tmpvar_34.x), mix (texelFetch (sGpuCache, (tmpvar_36 + ivec2(2, 0)), 0), texelFetch (sGpuCache, (tmpvar_36 + ivec2(3, 0)), 0), tmpvar_34.x), tmpvar_34.y);
  float tmpvar_38;
