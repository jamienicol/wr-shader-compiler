...
void main ()
{
  ...
  if ((prim_yuv_format_39 == 1)) {
    ...
    vec3 tmpvar_53;
    tmpvar_53.xy = mix (tmpvar_48.xy, tmpvar_48.zw, f_40);
    tmpvar_53.z = texelFetchOffset (sGpuCache, tmpvar_47, 0, ivec2(1, 0)).x;
    vec4 tmpvar_54;
    ...
    vec3 tmpvar_55;
    tmpvar_55.xy = mix (tmpvar_50.xy, tmpvar_50.zw, f_40);
    tmpvar_55.z = texelFetchOffset (sGpuCache, tmpvar_49, 0, ivec2(1, 0)).x;
    vec4 tmpvar_56;
    ...
    vec3 tmpvar_57;
    tmpvar_57.xy = mix (tmpvar_52.xy, tmpvar_52.zw, f_40);
    tmpvar_57.z = texelFetchOffset (sGpuCache, tmpvar_51, 0, ivec2(1, 0)).x;
    vec4 tmpvar_58;
    ...
    if ((prim_yuv_format_39 == 0)) {
      ivec2 tmpvar_59;
      tmpvar_59.x = int((uint(tmpvar_11.x) % 1024u));
      tmpvar_59.y = int((uint(tmpvar_11.x) / 1024u));
      vec4 tmpvar_60;
      tmpvar_60 = texelFetchOffset (sGpuCache, tmpvar_59, 0, ivec2(0, 0));
      ivec2 tmpvar_61;
      tmpvar_61.x = int((uint(tmpvar_11.y) % 1024u));
      tmpvar_61.y = int((uint(tmpvar_11.y) / 1024u));
      vec4 tmpvar_62;
      tmpvar_62 = texelFetchOffset (sGpuCache, tmpvar_61, 0, ivec2(0, 0));
      vec3 tmpvar_63;
      tmpvar_63.xy = mix (tmpvar_60.xy, tmpvar_60.zw, f_40);
      tmpvar_63.z = texelFetchOffset (sGpuCache, tmpvar_59, 0, ivec2(1, 0)).x;
      vec4 tmpvar_64;
      ...
      vec3 tmpvar_65;
      tmpvar_65.xy = mix (tmpvar_62.xy, tmpvar_62.zw, f_40);
      tmpvar_65.z = texelFetchOffset (sGpuCache, tmpvar_61, 0, ivec2(1, 0)).x;
      vec4 tmpvar_66;
      ...
      if ((prim_yuv_format_39 == 2)) {
        ivec2 tmpvar_67;
        tmpvar_67.x = int((uint(tmpvar_11.x) % 1024u));
        tmpvar_67.y = int((uint(tmpvar_11.x) / 1024u));
        vec4 tmpvar_68;
        tmpvar_68 = texelFetchOffset (sGpuCache, tmpvar_67, 0, ivec2(0, 0));
        vec3 tmpvar_69;
        tmpvar_69.xy = mix (tmpvar_68.xy, tmpvar_68.zw, f_40);
        tmpvar_69.z = texelFetchOffset (sGpuCache, tmpvar_67, 0, ivec2(1, 0)).x;
        vec4 tmpvar_70;
