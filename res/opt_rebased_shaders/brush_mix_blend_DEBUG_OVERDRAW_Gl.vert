...
void main ()
{
  ...
  vec4 tmpvar_39;
  tmpvar_39 = texelFetchOffset (sRenderTasks, tmpvar_38, 0, ivec2(1, 0));
  varying_vec4_0.xy = (((
    (vi_world_pos_19.xy * (tmpvar_39.y / max (0.0, vi_world_pos_19.w)))
   + texelFetchOffset (sRenderTasks, tmpvar_38, 0, ivec2(0, 0)).xy) - tmpvar_39.zw) / tmpvar_37);
  ...
  varying_vec4_1.xy = (((
   ...
   + texelFetchOffset (sRenderTasks, tmpvar_40, 0, ivec2(0, 0)).xy) - (tmpvar_39.zw * 
    (tmpvar_18.y / tmpvar_39.y)
  )) / tmpvar_37);
  varying_vec4_1.w = texelFetchOffset (sRenderTasks, tmpvar_40, 0, ivec2(1, 0)).x;
}
