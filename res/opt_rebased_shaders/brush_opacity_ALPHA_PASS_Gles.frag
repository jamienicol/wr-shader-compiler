...
void main ()
{
  ...
  frag_color_1 = (alpha_2 * tmpvar_15);
  float tmpvar_16;
  if ((vClipMaskUvBounds.xy == vClipMaskUvBounds.zw)) {
    ...
    bvec4 tmpvar_18;
    tmpvar_18.xy = greaterThanEqual (tmpvar_17, vClipMaskUvBounds.xy);
    tmpvar_18.zw = lessThan (tmpvar_17, vClipMaskUvBounds.zw);
    bool tmpvar_19;
    tmpvar_19 = (tmpvar_18 == bvec4(1, 1, 1, 1));
    if (!(tmpvar_19)) {
      tmpvar_16 = 0.0;
    } else {
      ivec3 tmpvar_20;
      tmpvar_20.xy = ivec2(tmpvar_17);
      tmpvar_20.z = int((vClipMaskUv.z + 0.5));
      tmpvar_16 = texelFetch (sPrevPassAlpha, tmpvar_20, 0).x;
    };
  };
  frag_color_1 = (frag_color_1 * tmpvar_16);
