...
void main ()
{
  ...
  ivec2 tmpvar_66;
  tmpvar_66.x = int((uint(instance_resource_address_5) % 1024u));
  tmpvar_66.y = int((uint(instance_resource_address_5) / 1024u));
  vec4 tmpvar_67;
  tmpvar_67 = texelFetchOffset (sGpuCache, tmpvar_66, 0, ivec2(0, 0));
  float tmpvar_68;
  tmpvar_68 = texelFetchOffset (sGpuCache, tmpvar_66, 0, ivec2(1, 0)).x;
  uv0_61 = tmpvar_67.xy;
  uv1_60 = tmpvar_67.zw;
  ...
  if (((tmpvar_36 & 2) != 0)) {
    ...
    if (((tmpvar_36 & 128) != 0)) {
      vec2 original_stretch_size_69;
      vec2 segment_uv_size_70;
      vec2 tmpvar_71;
      tmpvar_71 = (tmpvar_67.zw - tmpvar_67.xy);
      uv0_61 = (tmpvar_67.xy + (segment_data_34.xy * tmpvar_71));
      uv1_60 = (tmpvar_67.xy + (segment_data_34.zw * tmpvar_71));
      segment_uv_size_70 = (uv1_60 - uv0_61);
      if (((tmpvar_36 & 64) != 0)) {
        segment_uv_size_70 = (uv0_61 - tmpvar_67.xy);
        stretch_size_57 = (segment_rect_p0_32 - tmpvar_8.xy);
        if (((segment_uv_size_70.x < 0.001) || (stretch_size_57.x < 0.001))) {
          segment_uv_size_70.x = (tmpvar_67.z - uv1_60.x);
          stretch_size_57.x = (((tmpvar_8.x + tmpvar_8.z) - segment_rect_p0_32.x) - segment_rect_size_33.x);
        };
        if (((segment_uv_size_70.y < 0.001) || (stretch_size_57.y < 0.001))) {
          segment_uv_size_70.y = (tmpvar_67.w - uv1_60.y);
          stretch_size_57.y = (((tmpvar_8.y + tmpvar_8.w) - segment_rect_p0_32.y) - segment_rect_size_33.y);
        };
      };
      original_stretch_size_69 = stretch_size_57;
      if (((tmpvar_36 & 4) != 0)) {
        stretch_size_57.x = ((stretch_size_57.y / segment_uv_size_70.y) * segment_uv_size_70.x);
      };
      if (((tmpvar_36 & 8) != 0)) {
        stretch_size_57.y = ((original_stretch_size_69.x / segment_uv_size_70.x) * segment_uv_size_70.y);
      };
    } else {
      if (((tmpvar_36 & 4) != 0)) {
  ...
  flat_varying_vec4_4.x = tmpvar_68;
  flat_varying_vec4_4.y = tmpvar_72;
  vec2 tmpvar_73;
  tmpvar_73 = min (uv0_61, uv1_60);
  vec4 tmpvar_74;
  tmpvar_74.xy = (tmpvar_73 + vec2(0.5, 0.5));
  tmpvar_74.zw = (max (uv0_61, uv1_60) - vec2(0.5, 0.5));
  flat_varying_vec4_3 = tmpvar_74;
  f_56 = ((vi_local_pos_30 - local_rect_p0_58) / local_rect_size_59);
  int tmpvar_75;
  tmpvar_75 = (tmpvar_14.x & 65535);
  color_mode_55 = tmpvar_75;
  int tmpvar_76;
  tmpvar_76 = (tmpvar_14.x >> 16);
  if ((tmpvar_75 == 0)) {
    color_mode_55 = uMode;
  };
  bool tmpvar_77;
  tmpvar_77 = bool(0);
  while (true) {
    tmpvar_77 = (tmpvar_77 || (1 == tmpvar_14.y));
    if (tmpvar_77) {
      int tmpvar_78;
      tmpvar_78 = (instance_resource_address_5 + 2);
      ivec2 tmpvar_79;
      tmpvar_79.x = int((uint(tmpvar_78) % 1024u));
      tmpvar_79.y = int((uint(tmpvar_78) / 1024u));
      vec4 tmpvar_80;
      tmpvar_80 = mix (mix (texelFetchOffset (sGpuCache, tmpvar_79, 0, ivec2(0, 0)), texelFetchOffset (sGpuCache, tmpvar_79, 0, ivec2(1, 0)), f_56.x), mix (texelFetchOffset (sGpuCache, tmpvar_79, 0, ivec2(2, 0)), texelFetchOffset (sGpuCache, tmpvar_79, 0, ivec2(3, 0)), f_56.x), f_56.y);
      f_56 = (tmpvar_80.xy / tmpvar_80.w);
      break;
    };
    tmpvar_77 = bool(1);
    break;
  ...
  vec2 tmpvar_81;
  tmpvar_81 = (local_rect_size_59 / stretch_size_57);
  varying_vec4_0.zw = (mix (uv0_61, uv1_60, f_56) - tmpvar_73);
  varying_vec4_0.zw = varying_vec4_0.zw;
  varying_vec4_0.zw = (varying_vec4_0.zw * tmpvar_81);
  if ((tmpvar_72 == 0.0)) {
    varying_vec4_0.zw = (varying_vec4_0.zw * vi_world_pos_31.w);
  };
  vec4 tmpvar_82;
  tmpvar_82.xy = vec2(0.0, 0.0);
  tmpvar_82.zw = vec2(textureSize (sColor0));
  flat_varying_vec4_2 = tmpvar_82;
  flat_varying_vec4_1.zw = tmpvar_81;
  float tmpvar_83;
  tmpvar_83 = (float(tmpvar_14.z) / 65535.0);
  bool tmpvar_84;
  tmpvar_84 = bool(0);
  while (true) {
    tmpvar_84 = (tmpvar_84 || (0 == tmpvar_76));
    if (tmpvar_84) {
      image_data_color_62.w = (image_data_color_62.w * tmpvar_83);
      break;
    };
    tmpvar_84 = bool(1);
    image_data_color_62 = (image_data_color_62 * tmpvar_83);
    break;
  };
  bool tmpvar_85;
  tmpvar_85 = bool(0);
  while (true) {
    tmpvar_85 = (tmpvar_85 || (1 == color_mode_55));
    tmpvar_85 = (tmpvar_85 || (7 == color_mode_55));
    if (tmpvar_85) {
      flat_varying_vec4_1.xy = vec2(0.0, 1.0);
      flat_varying_vec4_0 = image_data_color_62;
      break;
    };
    tmpvar_85 = (tmpvar_85 || (5 == color_mode_55));
    tmpvar_85 = (tmpvar_85 || (6 == color_mode_55));
    tmpvar_85 = (tmpvar_85 || (9 == color_mode_55));
    if (tmpvar_85) {
      flat_varying_vec4_1.xy = vec2(1.0, 0.0);
      flat_varying_vec4_0 = image_data_color_62;
      break;
    };
    tmpvar_85 = (tmpvar_85 || (2 == color_mode_55));
    tmpvar_85 = (tmpvar_85 || (3 == color_mode_55));
    tmpvar_85 = (tmpvar_85 || (8 == color_mode_55));
    if (tmpvar_85) {
      flat_varying_vec4_1.xy = vec2(1.0, 0.0);
      flat_varying_vec4_0 = image_data_color_62.wwww;
      break;
    };
    tmpvar_85 = (tmpvar_85 || (4 == color_mode_55));
    if (tmpvar_85) {
