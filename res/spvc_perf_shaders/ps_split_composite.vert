...
void main()
{
    ...
    mat4 _1600 = _1631;
    _1600[0] = texelFetch(sTransformPalette, _1043, 0);
    mat4 _1602 = _1600;
    _1602[1] = texelFetch(sTransformPalette, _1043 + ivec2(1, 0), 0);
    mat4 _1604 = _1602;
    _1604[2] = texelFetch(sTransformPalette, _1043 + ivec2(2, 0), 0);
    mat4 _1606 = _1604;
    _1606[3] = texelFetch(sTransformPalette, _1043 + ivec2(3, 0), 0);
    int _662 = _947.x;
    ...
    vec4 _707 = _1606 * vec4(_1225, 0.0, 1.0);
    float _711 = _707.w;
    vec2 _714 = _707.xy;
    vClipMaskUvBounds = vec4(_1636, _1636 + _1635);
    vClipMaskUv = vec4((_714 * _1633) + ((_1636 - _1632) * _711), _1634, _711);
