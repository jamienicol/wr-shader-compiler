...
void main()
{
    ...
    mat4 _2301 = _2340;
    _2301[0] = texelFetch(sTransformPalette, _1409, 0);
    mat4 _2303 = _2301;
    _2303[1] = texelFetch(sTransformPalette, _1409 + ivec2(1, 0), 0);
    mat4 _2305 = _2303;
    _2305[2] = texelFetch(sTransformPalette, _1409 + ivec2(2, 0), 0);
    mat4 _2307 = _2305;
    _2307[3] = texelFetch(sTransformPalette, _1409 + ivec2(3, 0), 0);
    vec4 _2347;
    vec2 _2348;
    if ((_1227 >> 24) == 0)
    {
        vec2 _1528 = clamp(_2346 + (_2344 * aPosition.xy), _1194, _1194 + _1196);
        vec4 _1485 = _2307 * vec4(_1528, 0.0, 1.0);
        float _1501 = _1485.w;
    ...
    else
    {
        ...
        vec2 _1588 = _1586.xy;
        vec2 _1609 = (_2346 - _1588) + ((_2344 + (_1588 + _1586.zw)) * aPosition.xy);
        vec4 _1621 = _2307 * vec4(_1609, 0.0, 1.0);
        float _1629 = _1621.w;
        gl_Position = uTransform * vec4((_1621.xy * _1267) + ((_1301 - _1270) * _1629), _1221 * _1629, _1629);
        vTransformBounds = mix(vec4(clamp(_1188, _1194, _1679), clamp(_1188 + _1190, _1194, _1679)), vec4(clamp(_2346, _1194, _1679), clamp(_2346 + _2344, _1194, _1679)), _976);
        _2348 = _1609;
        _2347 = _1621;
    }
    vClipMaskUvBounds = vec4(_2337, _2337 + _2336);
    vClipMaskUv = vec4((_2347.xy * _2334) + ((_2337 - _2333) * _2347.w), _2335, _2347.w);
    int _1753 = _1218.x;
    ...
    vec2 _1791 = (mix(_1847.xy, _1847.zw, _1893.xy / vec2(_1893.w)) / _1763) * mix(_2347.w, 1.0, _1783);
    ...
    varying_vec4_0 = vec4(_2348.x, _2348.y, varying_vec4_0.z, varying_vec4_0.w);
