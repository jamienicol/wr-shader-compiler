...
void main()
{
    ...
    {
        highp vec2 _598 = _434;
        _598.x = flat_varying_vec4_2.z;
        _605 = _598;
    }
    else
    {
    ...
    {
        highp vec2 _602 = _605;
        _602.y = flat_varying_vec4_2.w;
        _606 = _602;
    }
    else
    {
    ...
    highp vec4 _390 = texture(sColor0, vec3(clamp(_606, flat_varying_vec4_3.xy, flat_varying_vec4_3.zw), flat_varying_vec4_4.x));
    ...
    switch (0u)
    {
        default:
        {
            ...
            _607 = 0.5 + (_515 * (((0.8431026935577392578125 * _515) * _515) - 1.14453601837158203125));
            break;
        }
    }
    ...
    switch (0u)
    {
        default:
        {
            ...
            _609 = texelFetch(sPrevPassAlpha, ivec3(ivec2(_554), int(vClipMaskUv.z + 0.5)), 0).x;
            break;
        }
    }
    oFragColor = (flat_varying_vec4_0 * (vec4(_404.x, _404.y, _404.z, _390.w) * _607)) * _609;
}
