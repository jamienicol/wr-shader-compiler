...
void main()
{
    ...
    mat4 _2756 = _2805;
    _2756[0] = texelFetch(sTransformPalette, _1442, 0);
    mat4 _2758 = _2756;
    _2758[1] = texelFetch(sTransformPalette, _1442 + ivec2(1, 0), 0);
    mat4 _2760 = _2758;
    _2760[2] = texelFetch(sTransformPalette, _1442 + ivec2(2, 0), 0);
    mat4 _2762 = _2760;
    _2762[3] = texelFetch(sTransformPalette, _1442 + ivec2(3, 0), 0);
    vec2 _2810;
    if ((_1260 >> 24) == 0)
    {
        vec2 _1561 = clamp(_2808 + (_2807 * aPosition.xy), _1227, _1227 + _1229);
        vec4 _1518 = _2762 * vec4(_1561, 0.0, 1.0);
        float _1534 = _1518.w;
    ...
    else
    {
        ...
        vec2 _1620 = _1618.xy;
        vec2 _1641 = (_2808 - _1620) + ((_2807 + (_1620 + _1618.zw)) * aPosition.xy);
        vec4 _1653 = _2762 * vec4(_1641, 0.0, 1.0);
        float _1661 = _1653.w;
        gl_Position = uTransform * vec4((_1653.xy * _1300) + ((_1334 - _1303) * _1661), _1254 * _1661, _1661);
        vTransformBounds = mix(vec4(clamp(_1221, _1227, _1711), clamp(_1221 + _1223, _1227, _1711)), vec4(clamp(_2808, _1227, _1711), clamp(_2808 + _2807, _1227, _1711)), _858);
        _2810 = _1641;
    }
    vec2 _1779 = (_2810 - _1221) / _1223;
    ...
    if (vFormat == 1)
    {
        ...
        vec3 _2783 = vec3(_1924.x, _1924.y, _2814.z);
        _2783.z = texelFetch(sGpuCache, _1994 + ivec2(1, 0), 0).x;
        vec2 _1942 = _2783.xy / _1807;
        vUv_Y = vec3(_1942.x, _1942.y, _2783.z);
        ...
        vec3 _2787 = vec3(_2008.x, _2008.y, _2814.z);
        _2787.z = texelFetch(sGpuCache, _2078 + ivec2(1, 0), 0).x;
        vec2 _2026 = _2787.xy / _1818;
        vUv_U = vec3(_2026.x, _2026.y, _2787.z);
        ...
        vec3 _2791 = vec3(_2092.x, _2092.y, _2814.z);
        _2791.z = texelFetch(sGpuCache, _2162 + ivec2(1, 0), 0).x;
        vec2 _2110 = _2791.xy / _1829;
        vUv_V = vec3(_2110.x, _2110.y, _2791.z);
    ...
    else
    {
        if (vFormat == 0)
        {
            ...
            vec3 _2795 = vec3(_2176.x, _2176.y, _2814.z);
            _2795.z = texelFetch(sGpuCache, _2246 + ivec2(1, 0), 0).x;
            vec2 _2194 = _2795.xy / _1845;
            vUv_Y = vec3(_2194.x, _2194.y, _2795.z);
            ...
            vec3 _2799 = vec3(_2260.x, _2260.y, _2814.z);
            _2799.z = texelFetch(sGpuCache, _2330 + ivec2(1, 0), 0).x;
            vec2 _2278 = _2799.xy / _1856;
            vUv_U = vec3(_2278.x, _2278.y, _2799.z);
        ...
        else
        {
            if (vFormat == 2)
            {
                ...
                vec3 _2803 = vec3(_2344.x, _2344.y, _2814.z);
                _2803.z = texelFetch(sGpuCache, _2414 + ivec2(1, 0), 0).x;
                vec2 _2362 = _2803.xy / _1871;
                vUv_Y = vec3(_2362.x, _2362.y, _2803.z);
