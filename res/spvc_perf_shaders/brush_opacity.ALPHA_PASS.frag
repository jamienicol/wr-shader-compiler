...
void main()
{
    ...
    switch (0u)
    {
        default:
        {
            ...
            _561 = texelFetch(sPrevPassAlpha, ivec3(ivec2(_514), int(vClipMaskUv.z + 0.5)), 0).x;
            break;
        }
    }
    oFragColor = (vec4(_557, 1.0) * ((_370 * flat_varying_vec4_2.z) * min(_416.x * _416.y, _559))) * _561;
}
