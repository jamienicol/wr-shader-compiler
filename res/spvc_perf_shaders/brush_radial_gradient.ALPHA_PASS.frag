...
void main()
{
    ...
    if (_529.x >= _538.x)
    {
        highp vec2 _865 = _533;
        _865.x = flat_varying_vec4_1.x;
        _872 = _865;
    }
    else
    {
    ...
    if (_529.y >= _538.y)
    {
        highp vec2 _869 = _872;
        _869.y = flat_varying_vec4_1.y;
        _873 = _869;
    }
    else
    {
    ...
    highp vec2 _562 = _873 - flat_varying_vec4_0.xy;
    ...
    highp float _680 = 1.0 + (mix(_874, fract(_874), flat_varying_vec4_1.z) * 128.0);
    ...
    switch (0u)
    {
        default:
        {
            ...
            _876 = 0.5 + (_781 * (((0.8431026935577392578125 * _781) * _781) - 1.14453601837158203125));
            break;
        }
    }
    highp float _878;
    switch (0u)
    {
        default:
        {
            ...
            _878 = texelFetch(sPrevPassAlpha, ivec3(ivec2(_820), int(vClipMaskUv.z + 0.5)), 0).x;
            break;
        }
    }
    oFragColor = (mix(texelFetch(sGpuCache, _725, 0), texelFetch(sGpuCache, _725 + ivec2(1, 0), 0), vec4(fract(_680))) * _876) * _878;
}
