...
void main()
{
    ...
    mat4 _1760 = _1783;
    _1760[0] = texelFetch(sTransformPalette, _1196, 0);
    mat4 _1762 = _1760;
    _1762[1] = texelFetch(sTransformPalette, _1196 + ivec2(1, 0), 0);
    mat4 _1764 = _1762;
    _1764[2] = texelFetch(sTransformPalette, _1196 + ivec2(2, 0), 0);
    mat4 _1766 = _1764;
    _1766[3] = texelFetch(sTransformPalette, _1196 + ivec2(3, 0), 0);
    if ((_1014 >> 24) == 0)
    {
        vec4 _1272 = _1766 * vec4(clamp(_1786 + (_1785 * aPosition.xy), _981, _981 + _983), 0.0, 1.0);
        float _1288 = _1272.w;
    ...
    else
    {
        ...
        vec2 _1374 = _1372.xy;
        vec4 _1407 = _1766 * vec4((_1786 - _1374) + ((_1785 + (_1374 + _1372.zw)) * aPosition.xy), 0.0, 1.0);
        float _1415 = _1407.w;
        gl_Position = uTransform * vec4((_1407.xy * _1054) + ((_1088 - _1057) * _1415), _1008 * _1415, _1415);
        vTransformBounds = mix(vec4(clamp(_975, _981, _1465), clamp(_975 + _977, _981, _1465)), vec4(clamp(_1786, _981, _1465), clamp(_1786 + _1785, _981, _1465)), _824);
    }
