...
void main()
{
    ...
    else
    {
        ...
        _2168 = texelFetch(sGpuCache, _1169 + ivec2(1, 0), 0);
        _2161 = _1153.xy + _1100;
        _2159 = _1153.zw;
    }
    ...
    mat4 _2123 = _2155;
    _2123[0] = texelFetch(sTransformPalette, _1321, 0);
    mat4 _2125 = _2123;
    _2125[1] = texelFetch(sTransformPalette, _1321 + ivec2(1, 0), 0);
    mat4 _2127 = _2125;
    _2127[2] = texelFetch(sTransformPalette, _1321 + ivec2(2, 0), 0);
    mat4 _2129 = _2127;
    _2129[3] = texelFetch(sTransformPalette, _1321 + ivec2(3, 0), 0);
    vec4 _2162;
    vec2 _2163;
    if ((_1139 >> 24) == 0)
    {
        vec2 _1440 = clamp(_2161 + (_2159 * aPosition.xy), _1106, _1106 + _1108);
        vec4 _1397 = _2129 * vec4(_1440, 0.0, 1.0);
        float _1413 = _1397.w;
    ...
    else
    {
        ...
        vec2 _1500 = _1498.xy;
        vec2 _1521 = (_2161 - _1500) + ((_2159 + (_1500 + _1498.zw)) * aPosition.xy);
        vec4 _1533 = _2129 * vec4(_1521, 0.0, 1.0);
        float _1541 = _1533.w;
        gl_Position = uTransform * vec4((_1533.xy * _1179) + ((_1213 - _1182) * _1541), _1133 * _1541, _1541);
        vTransformBounds = mix(vec4(clamp(_1100, _1106, _1591), clamp(_1100 + _1102, _1106, _1591)), vec4(clamp(_2161, _1106, _1591), clamp(_2161 + _2159, _1106, _1591)), _857);
        _2163 = _1521;
        _2162 = _1533;
    }
    vClipMaskUvBounds = vec4(_2152, _2152 + _2151);
    vClipMaskUv = vec4((_2162.xy * _2149) + ((_2152 - _2148) * _2162.w), _2150, _2162.w);
    ...
    if ((((_1060 >> 8) & 255) & 2) != 0)
    {
        vec2 _1675 = (_2163 - _2161) / _2159;
        varying_vec4_0 = vec4(varying_vec4_0.x, varying_vec4_0.y, _1675.x, _1675.y);
        vec2 _1688 = (varying_vec4_0.zw * (_2168.zw - _2168.xy)) + _2168.xy;
    ...
    varying_vec4_0 = vec4(_2163.x, _2163.y, varying_vec4_0.z, varying_vec4_0.w);
}
