...
void main()
{
    ...
    mat4 _3045 = _3085;
    _3045[0] = texelFetch(sTransformPalette, _1793, 0);
    mat4 _3047 = _3045;
    _3047[1] = texelFetch(sTransformPalette, _1793 + ivec2(1, 0), 0);
    mat4 _3049 = _3047;
    _3049[2] = texelFetch(sTransformPalette, _1793 + ivec2(2, 0), 0);
    mat4 _3051 = _3049;
    _3051[3] = texelFetch(sTransformPalette, _1793 + ivec2(3, 0), 0);
    vec4 _3089;
    vec2 _3090;
    if ((_1611 >> 24) == 0)
    {
        vec2 _1912 = clamp(_3088 + (_3087 * aPosition.xy), _1578, _1578 + _1580);
        vec4 _1869 = _3051 * vec4(_1912, 0.0, 1.0);
        float _1885 = _1869.w;
    ...
    else
    {
        ...
        vec2 _1971 = _1969.xy;
        vec2 _1992 = (_3088 - _1971) + ((_3087 + (_1971 + _1969.zw)) * aPosition.xy);
        vec4 _2004 = _3051 * vec4(_1992, 0.0, 1.0);
        float _2012 = _2004.w;
        gl_Position = uTransform * vec4((_2004.xy * _1651) + ((_1685 - _1654) * _2012), _1605 * _2012, _2012);
        vTransformBounds = mix(vec4(clamp(_1572, _1578, _2062), clamp(_1572 + _1574, _1578, _2062)), vec4(clamp(_3088, _1578, _2062), clamp(_3088 + _3087, _1578, _2062)), _943);
        _3090 = _1992;
        _3089 = _2004;
    }
    int _2116 = _1602.x;
    ...
    vec2 _2154 = (mix(_2580.xy, _2580.zw, _2626.xy / vec2(_2626.w)) / _2126) * mix(_3089.w, 1.0, _2146);
    ...
    varying_vec4_0 = vec4(_3090.x, _3090.y, varying_vec4_0.z, varying_vec4_0.w);
    int _2183 = _1602.z;
