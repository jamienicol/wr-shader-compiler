...
void main()
{
    ...
    else
    {
        ...
        _2008 = texelFetch(sGpuCache, _1119 + ivec2(1, 0), 0);
        _2002 = _1103.xy + _1050;
        _2001 = _1103.zw;
    }
    ...
    mat4 _1972 = _1999;
    _1972[0] = texelFetch(sTransformPalette, _1271, 0);
    mat4 _1974 = _1972;
    _1974[1] = texelFetch(sTransformPalette, _1271 + ivec2(1, 0), 0);
    mat4 _1976 = _1974;
    _1976[2] = texelFetch(sTransformPalette, _1271 + ivec2(2, 0), 0);
    mat4 _1978 = _1976;
    _1978[3] = texelFetch(sTransformPalette, _1271 + ivec2(3, 0), 0);
    vec2 _2004;
    if ((_1089 >> 24) == 0)
    {
        vec2 _1390 = clamp(_2002 + (_2001 * aPosition.xy), _1056, _1056 + _1058);
        vec4 _1347 = _1978 * vec4(_1390, 0.0, 1.0);
        float _1363 = _1347.w;
    ...
    else
    {
        ...
        vec2 _1449 = _1447.xy;
        vec2 _1470 = (_2002 - _1449) + ((_2001 + (_1449 + _1447.zw)) * aPosition.xy);
        vec4 _1482 = _1978 * vec4(_1470, 0.0, 1.0);
        float _1490 = _1482.w;
        gl_Position = uTransform * vec4((_1482.xy * _1129) + ((_1163 - _1132) * _1490), _1083 * _1490, _1490);
        vTransformBounds = mix(vec4(clamp(_1050, _1056, _1540), clamp(_1050 + _1052, _1056, _1540)), vec4(clamp(_2002, _1056, _1540), clamp(_2002 + _2001, _1056, _1540)), _810);
        _2004 = _1470;
    }
    ...
    if ((((_1010 >> 8) & 255) & 2) != 0)
    {
        vec2 _1586 = (_2004 - _2002) / _2001;
        varying_vec4_0 = vec4(varying_vec4_0.x, varying_vec4_0.y, _1586.x, _1586.y);
        vec2 _1599 = (varying_vec4_0.zw * (_2008.zw - _2008.xy)) + _2008.xy;
