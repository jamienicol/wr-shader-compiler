...
void main()
{
    vec4 _242 = texture(sColor0, vec3(clamp((varying_vec4_0.zw * mix(gl_FragCoord.w, 1.0, flat_varying_vec4_4.y)) + flat_varying_vec4_2.xy, flat_varying_vec4_3.xy, flat_varying_vec4_3.zw), _328).xy);
    ...
    switch (0u)
    {
        default:
        {
            ...
            _326 = texelFetch(sPrevPassAlpha, ivec3(ivec2(_285), int(vClipMaskUv.z + 0.5)), 0).x;
            break;
        }
    }
    oFragColor = (flat_varying_vec4_0 * (vec4(_253.x, _253.y, _253.z, _242.w) * 1.0)) * _326;
}
