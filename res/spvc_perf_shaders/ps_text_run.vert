...
void main()
{
    ...
    mat4 _1580 = _1609;
    _1580[0] = texelFetch(sTransformPalette, _1001, 0);
    mat4 _1582 = _1580;
    _1582[1] = texelFetch(sTransformPalette, _1001 + ivec2(1, 0), 0);
    mat4 _1584 = _1582;
    _1584[2] = texelFetch(sTransformPalette, _1001 + ivec2(2, 0), 0);
    mat4 _1586 = _1584;
    _1586[3] = texelFetch(sTransformPalette, _1001 + ivec2(3, 0), 0);
    vec2 _1610;
    float _1611;
    float _1612;
    vec2 _1613;
    ...
    switch ((_891 >> 8) & 255)
    {
        case 1:
        {
            _1616 = vec2(0.125, 0.5);
            break;
        }
        case 2:
        {
            _1616 = vec2(0.5, 0.125);
            break;
        }
        case 3:
        {
    ...
    vec2 _690 = ((_1286.yz + floor(((vec2(_1234.x ? _1229.x : _1227.x, _1234.y ? _1229.y : _1227.y) + texelFetch(sPrimitiveHeadersF, _919, 0).xy) * (1.0 / _669)) + _1616)) * _669) + (vec2(_961.xy) * vec2(0.00390625));
    vec2 _694 = _1281.zw;
    vec2 _697 = _1281.xy;
    vec2 _699 = (_694 - _697) * _669;
    vec2 _1307 = clamp(_690 + (_699 * aPosition.xy), _937, _937 + _929.zw);
    vec4 _726 = _1586 * vec4(_1307, 0.0, 1.0);
    vec2 _729 = _726.xy;
    float _749 = _726.w;
    gl_Position = uTransform * vec4((_729 * _1129) + (((-_1161.zw) + texelFetch(sRenderTasks, _1151, 0).xy) * _749), float(_956.x) * _749, _749);
    vClipMaskUvBounds = vec4(_1614, _1614 + _1613);
    vClipMaskUv = vec4((_729 * _1611) + ((_1614 - _1610) * _749), _1612, _749);
    switch (_1619)
    {
        case 1:
        case 7:
