...
void main()
{
    ...
    switch (vStyle)
    {
        ...
        case 2:
        {
            _347 = step(floor(vLocalPos.x + 0.5), vParams.y);
            break;
        }
        case 1:
        {
            ...
            switch (0u)
            {
                default:
                {
                    ...
                    _346 = 0.5 + (_268 * (((0.8431026935577392578125 * _268) * _268) - 1.14453601837158203125));
                    break;
                }
            }
            _347 = _346;
        ...
        case 3:
        {
            ...
            highp vec2 _344 = vLocalPos;
            _344.x = mod(vLocalPos.x, _145);
            highp float _181 = _163 * 2.0;
            highp vec2 _290 = vec2(0.0, _171) - _344;
            highp float _345;
            switch (0u)
            {
                default:
                {
                    highp float _322 = (0.5 * (abs(max(max(dot(normalize(vec2(1.0, _181)), _290), dot(normalize(vec2(0.0, _181)), _290)), dot(normalize(vec2(-1.0, _181)), vec2(vParams.z, _171) - _344))) - vParams.x)) / _258;
                    ...
                    _345 = 0.5 + (_322 * (((0.8431026935577392578125 * _322) * _322) - 1.14453601837158203125));
                    break;
                }
            }
            highp float _348;
