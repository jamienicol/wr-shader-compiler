...
void main()
{
    ...
    if (vLocalPos.w > 0.0)
    {
        ...
        switch (0u)
        {
            default:
            {
                ...
                _281 = 0.5 + (_261 * (((0.8431026935577392578125 * _261) * _261) - 1.14453601837158203125));
                break;
            }
        }
        _282 = _281;
    ...
    oFragColor = vec4(_282 * texture(sColor0, vec3(clamp(((_145 / _125) * vClipMaskUvRect.zw) + vClipMaskUvRect.xy, vClipMaskUvInnerRect.xy, vClipMaskUvInnerRect.zw), vLayer)).x, 1.0, 1.0, 1.0);
}
