...
void main()
{
    ...
    mat4 _3461 = _3503;
    _3461[0] = texelFetch(sTransformPalette, _1435, 0);
    mat4 _3463 = _3461;
    _3463[1] = texelFetch(sTransformPalette, _1435 + ivec2(1, 0), 0);
    mat4 _3465 = _3463;
    _3465[2] = texelFetch(sTransformPalette, _1435 + ivec2(2, 0), 0);
    mat4 _3467 = _3465;
    _3467[3] = texelFetch(sTransformPalette, _1435 + ivec2(3, 0), 0);
    vec2 _3422;
    if ((_1253 >> 24) == 0)
    {
        vec2 _1554 = clamp(_3405 + (_3403 * aPosition.xy), _1220, _1220 + _1222);
        vec4 _1511 = _3467 * vec4(_1554, 0.0, 1.0);
        float _1527 = _1511.w;
    ...
    else
    {
        ...
        vec2 _1613 = _1611.xy;
        vec2 _1634 = (_3405 - _1613) + ((_3403 + (_1613 + _1611.zw)) * aPosition.xy);
        vec4 _1646 = _3467 * vec4(_1634, 0.0, 1.0);
        float _1654 = _1646.w;
        gl_Position = uTransform * vec4((_1646.xy * _1293) + ((_1327 - _1296) * _1654), _1247 * _1654, _1654);
        vTransformBounds = mix(vec4(clamp(_1214, _1220, _1704), clamp(_1214 + _1216, _1220, _1704)), vec4(clamp(_3405, _1220, _1704), clamp(_3405 + _3403, _1220, _1704)), _858);
        _3422 = _1634;
    }
    vec2 _1772 = (_3422 - _1214) / _1216;
    ...
    if (vFormat == 1)
    {
        ...
        vec3 _3480 = vec3(_1911.x, _1911.y, _3501.z);
        _3480.z = texelFetch(sGpuCache, _1981 + ivec2(1, 0), 0).x;
        vec2 _1929 = _3480.xy / _1799;
        vUv_Y = vec3(_1929.x, _1929.y, _3480.z);
        ...
        vec3 _3484 = vec3(_1995.x, _1995.y, _3501.z);
        _3484.z = texelFetch(sGpuCache, _2065 + ivec2(1, 0), 0).x;
        vec2 _2013 = _3484.xy / _1809;
        vUv_U = vec3(_2013.x, _2013.y, _3484.z);
        ...
        vec3 _3488 = vec3(_2079.x, _2079.y, _3501.z);
        _3488.z = texelFetch(sGpuCache, _2149 + ivec2(1, 0), 0).x;
        vec2 _2097 = _3488.xy / _1819;
        vUv_V = vec3(_2097.x, _2097.y, _3488.z);
    ...
    else
    {
        if (vFormat == 0)
        {
            ...
            vec3 _3492 = vec3(_2163.x, _2163.y, _3501.z);
            _3492.z = texelFetch(sGpuCache, _2233 + ivec2(1, 0), 0).x;
            vec2 _2181 = _3492.xy / _1834;
            vUv_Y = vec3(_2181.x, _2181.y, _3492.z);
            ...
            vec3 _3496 = vec3(_2247.x, _2247.y, _3501.z);
            _3496.z = texelFetch(sGpuCache, _2317 + ivec2(1, 0), 0).x;
            vec2 _2265 = _3496.xy / _1844;
            vUv_U = vec3(_2265.x, _2265.y, _3496.z);
        ...
        else
        {
            if (vFormat == 2)
            {
                ...
                vec3 _3500 = vec3(_2331.x, _2331.y, _3501.z);
                _3500.z = texelFetch(sGpuCache, _2401 + ivec2(1, 0), 0).x;
                vec2 _2349 = _3500.xy / _1858;
                vUv_Y = vec3(_2349.x, _2349.y, _3500.z);
