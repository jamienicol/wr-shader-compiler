...
void main()
{
    ...
    mat4 _2803 = _2826;
    _2803[0] = texelFetch(sTransformPalette, _1313, 0);
    mat4 _2805 = _2803;
    _2805[1] = texelFetch(sTransformPalette, _1313 + ivec2(1, 0), 0);
    mat4 _2807 = _2805;
    _2807[2] = texelFetch(sTransformPalette, _1313 + ivec2(2, 0), 0);
    mat4 _2809 = _2807;
    _2809[3] = texelFetch(sTransformPalette, _1313 + ivec2(3, 0), 0);
    vec4 _2759;
    if ((_1131 >> 24) == 0)
    {
        vec4 _1389 = _2809 * vec4(clamp(_2743 + (_2741 * aPosition.xy), _1098, _1098 + _1100), 0.0, 1.0);
        float _1405 = _1389.w;
    ...
    else
    {
        ...
        vec2 _1492 = _1490.xy;
        vec4 _1525 = _2809 * vec4((_2743 - _1492) + ((_2741 + (_1492 + _1490.zw)) * aPosition.xy), 0.0, 1.0);
        float _1533 = _1525.w;
        gl_Position = uTransform * vec4((_1525.xy * _1171) + ((_1205 - _1174) * _1533), _1125 * _1533, _1533);
        vTransformBounds = mix(vec4(clamp(_1092, _1098, _1583), clamp(_1092 + _1094, _1098, _1583)), vec4(clamp(_2743, _1098, _1583), clamp(_2743 + _2741, _1098, _1583)), _893);
        _2759 = _1525;
    }
    vClipMaskUvBounds = vec4(_2735, _2735 + _2734);
    vClipMaskUv = vec4((_2759.xy * _2732) + ((_2735 - _2731) * _2759.w), _2733, _2759.w);
    vec2 _1664 = (_2759.xy * _1171) / vec2(max(0.0, _2759.w));
