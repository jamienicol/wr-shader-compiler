...
void main()
{
    ...
    else
    {
        ...
        _2471 = texelFetch(sGpuCache, _1111 + ivec2(1, 0), 0);
        _2429 = _1095.xy + _1042;
        _2427 = _1095.zw;
    }
    ...
    mat4 _2486 = _2502;
    _2486[0] = texelFetch(sTransformPalette, _1263, 0);
    mat4 _2488 = _2486;
    _2488[1] = texelFetch(sTransformPalette, _1263 + ivec2(1, 0), 0);
    mat4 _2490 = _2488;
    _2490[2] = texelFetch(sTransformPalette, _1263 + ivec2(2, 0), 0);
    mat4 _2492 = _2490;
    _2492[3] = texelFetch(sTransformPalette, _1263 + ivec2(3, 0), 0);
    vec2 _2446;
    if ((_1081 >> 24) == 0)
    {
        vec2 _1382 = clamp(_2429 + (_2427 * aPosition.xy), _1048, _1048 + _1050);
        vec4 _1339 = _2492 * vec4(_1382, 0.0, 1.0);
        float _1355 = _1339.w;
    ...
    else
    {
        ...
        vec2 _1441 = _1439.xy;
        vec2 _1462 = (_2429 - _1441) + ((_2427 + (_1441 + _1439.zw)) * aPosition.xy);
        vec4 _1474 = _2492 * vec4(_1462, 0.0, 1.0);
        float _1482 = _1474.w;
        gl_Position = uTransform * vec4((_1474.xy * _1121) + ((_1155 - _1124) * _1482), _1075 * _1482, _1482);
        vTransformBounds = mix(vec4(clamp(_1042, _1048, _1532), clamp(_1042 + _1044, _1048, _1532)), vec4(clamp(_2429, _1048, _1532), clamp(_2429 + _2427, _1048, _1532)), _810);
        _2446 = _1462;
    }
    ...
    if ((((_1002 >> 8) & 255) & 2) != 0)
    {
        vec2 _1581 = (_2446 - _2429) / _2427;
        varying_vec4_0 = vec4(varying_vec4_0.x, varying_vec4_0.y, _1581.x, _1581.y);
        vec2 _1594 = (varying_vec4_0.zw * (_2471.zw - _2471.xy)) + _2471.xy;
