...
void main()
{
    ...
    mat4 _2718 = _2741;
    _2718[0] = texelFetch(sTransformPalette, _1358, 0);
    mat4 _2720 = _2718;
    _2720[1] = texelFetch(sTransformPalette, _1358 + ivec2(1, 0), 0);
    mat4 _2722 = _2720;
    _2722[2] = texelFetch(sTransformPalette, _1358 + ivec2(2, 0), 0);
    mat4 _2724 = _2722;
    _2724[3] = texelFetch(sTransformPalette, _1358 + ivec2(3, 0), 0);
    vec4 _2681;
    vec2 _2682;
    if ((_1176 >> 24) == 0)
    {
        vec2 _1477 = clamp(_2665 + (_2663 * aPosition.xy), _1143, _1143 + _1145);
        vec4 _1434 = _2724 * vec4(_1477, 0.0, 1.0);
        float _1450 = _1434.w;
    ...
    else
    {
        ...
        vec2 _1536 = _1534.xy;
        vec2 _1557 = (_2665 - _1536) + ((_2663 + (_1536 + _1534.zw)) * aPosition.xy);
        vec4 _1569 = _2724 * vec4(_1557, 0.0, 1.0);
        float _1577 = _1569.w;
        gl_Position = uTransform * vec4((_1569.xy * _1216) + ((_1250 - _1219) * _1577), _1170 * _1577, _1577);
        vTransformBounds = mix(vec4(clamp(_1137, _1143, _1627), clamp(_1137 + _1139, _1143, _1627)), vec4(clamp(_2665, _1143, _1627), clamp(_2665 + _2663, _1143, _1627)), _929);
        _2682 = _1557;
        _2681 = _1569;
    }
    int _1666 = _1167.x;
    ...
    vec2 _1704 = (mix(_1760.xy, _1760.zw, _1806.xy / vec2(_1806.w)) / _1676) * mix(_2681.w, 1.0, _1696);
    ...
    varying_vec4_0 = vec4(_2682.x, _2682.y, varying_vec4_0.z, varying_vec4_0.w);
