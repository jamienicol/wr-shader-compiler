...
void main()
{
    ...
    mat4 _3610 = _3655;
    _3610[0] = texelFetch(sTransformPalette, _1490, 0);
    mat4 _3612 = _3610;
    _3612[1] = texelFetch(sTransformPalette, _1490 + ivec2(1, 0), 0);
    mat4 _3614 = _3612;
    _3614[2] = texelFetch(sTransformPalette, _1490 + ivec2(2, 0), 0);
    mat4 _3616 = _3614;
    _3616[3] = texelFetch(sTransformPalette, _1490 + ivec2(3, 0), 0);
    vec4 _3561;
    vec2 _3567;
    if ((_1308 >> 24) == 0)
    {
        vec2 _1609 = clamp(_3545 + (_3543 * aPosition.xy), _1275, _1275 + _1277);
        vec4 _1566 = _3616 * vec4(_1609, 0.0, 1.0);
        float _1582 = _1566.w;
    ...
    else
    {
        ...
        vec2 _1669 = _1667.xy;
        vec2 _1690 = (_3545 - _1669) + ((_3543 + (_1669 + _1667.zw)) * aPosition.xy);
        vec4 _1702 = _3616 * vec4(_1690, 0.0, 1.0);
        float _1710 = _1702.w;
        gl_Position = uTransform * vec4((_1702.xy * _1348) + ((_1382 - _1351) * _1710), _1302 * _1710, _1710);
        vTransformBounds = mix(vec4(clamp(_1269, _1275, _1760), clamp(_1269 + _1271, _1275, _1760)), vec4(clamp(_3545, _1275, _1760), clamp(_3545 + _3543, _1275, _1760)), _905);
        _3567 = _1690;
        _3561 = _1702;
    }
    vClipMaskUvBounds = vec4(_3537, _3537 + _3536);
    vClipMaskUv = vec4((_3561.xy * _3534) + ((_3537 - _3533) * _3561.w), _3535, _3561.w);
    vec2 _1863 = (_3567 - _1269) / _1271;
    ...
    if (vFormat == 1)
    {
        ...
        vec3 _3631 = vec3(_2004.x, _2004.y, _3652.z);
        _3631.z = texelFetch(sGpuCache, _2074 + ivec2(1, 0), 0).x;
        vec2 _2022 = _3631.xy / _1892;
        vUv_Y = vec3(_2022.x, _2022.y, _3631.z);
        ...
        vec3 _3635 = vec3(_2088.x, _2088.y, _3652.z);
        _3635.z = texelFetch(sGpuCache, _2158 + ivec2(1, 0), 0).x;
        vec2 _2106 = _3635.xy / _1902;
        vUv_U = vec3(_2106.x, _2106.y, _3635.z);
        ...
        vec3 _3639 = vec3(_2172.x, _2172.y, _3652.z);
        _3639.z = texelFetch(sGpuCache, _2242 + ivec2(1, 0), 0).x;
        vec2 _2190 = _3639.xy / _1912;
        vUv_V = vec3(_2190.x, _2190.y, _3639.z);
    ...
    else
    {
        if (vFormat == 0)
        {
            ...
            vec3 _3643 = vec3(_2256.x, _2256.y, _3652.z);
            _3643.z = texelFetch(sGpuCache, _2326 + ivec2(1, 0), 0).x;
            vec2 _2274 = _3643.xy / _1927;
            vUv_Y = vec3(_2274.x, _2274.y, _3643.z);
            ...
            vec3 _3647 = vec3(_2340.x, _2340.y, _3652.z);
            _3647.z = texelFetch(sGpuCache, _2410 + ivec2(1, 0), 0).x;
            vec2 _2358 = _3647.xy / _1937;
            vUv_U = vec3(_2358.x, _2358.y, _3647.z);
        ...
        else
        {
            if (vFormat == 2)
            {
                ...
                vec3 _3651 = vec3(_2424.x, _2424.y, _3652.z);
                _3651.z = texelFetch(sGpuCache, _2494 + ivec2(1, 0), 0).x;
                vec2 _2442 = _3651.xy / _1951;
                vUv_Y = vec3(_2442.x, _2442.y, _3651.z);
