...
void main()
{
    oFragColor = texture(sColor0, vec3(clamp(mod(varying_vec4_0.zw * mix(gl_FragCoord.w, 1.0, flat_varying_vec4_4.y), flat_varying_vec4_2.zw - flat_varying_vec4_2.xy) + flat_varying_vec4_2.xy, flat_varying_vec4_3.xy, flat_varying_vec4_3.zw), _185).xy);
}
