...
void main()
{
    ...
    mat4 _3777 = _3812;
    _3777[0] = texelFetch(sTransformPalette, _1844, 0);
    mat4 _3779 = _3777;
    _3779[1] = texelFetch(sTransformPalette, _1844 + ivec2(1, 0), 0);
    mat4 _3781 = _3779;
    _3781[2] = texelFetch(sTransformPalette, _1844 + ivec2(2, 0), 0);
    mat4 _3783 = _3781;
    _3783[3] = texelFetch(sTransformPalette, _1844 + ivec2(3, 0), 0);
    vec4 _3730;
    vec2 _3736;
    if ((_1662 >> 24) == 0)
    {
        vec2 _1963 = clamp(_3714 + (_3712 * aPosition.xy), _1629, _1629 + _1631);
        vec4 _1920 = _3783 * vec4(_1963, 0.0, 1.0);
        float _1936 = _1920.w;
    ...
    else
    {
        ...
        vec2 _2023 = _2021.xy;
        vec2 _2044 = (_3714 - _2023) + ((_3712 + (_2023 + _2021.zw)) * aPosition.xy);
        vec4 _2056 = _3783 * vec4(_2044, 0.0, 1.0);
        float _2064 = _2056.w;
        gl_Position = uTransform * vec4((_2056.xy * _1702) + ((_1736 - _1705) * _2064), _1656 * _2064, _2064);
        vTransformBounds = mix(vec4(clamp(_1623, _1629, _2114), clamp(_1623 + _1625, _1629, _2114)), vec4(clamp(_3714, _1629, _2114), clamp(_3714 + _3712, _1629, _2114)), _990);
        _3736 = _2044;
        _3730 = _2056;
    }
    vClipMaskUvBounds = vec4(_3706, _3706 + _3705);
    vClipMaskUv = vec4((_3730.xy * _3703) + ((_3706 - _3702) * _3730.w), _3704, _3730.w);
    int _2203 = _1653.x;
    ...
    vec2 _2241 = (mix(_2667.xy, _2667.zw, _2713.xy / vec2(_2713.w)) / _2213) * mix(_3730.w, 1.0, _2233);
    ...
    varying_vec4_0 = vec4(_3736.x, _3736.y, varying_vec4_0.z, varying_vec4_0.w);
    int _2270 = _1653.z;
