...
void main()
{
    ...
    mat4 _2662 = _2682;
    _2662[0] = texelFetch(sTransformPalette, _1262, 0);
    mat4 _2664 = _2662;
    _2664[1] = texelFetch(sTransformPalette, _1262 + ivec2(1, 0), 0);
    mat4 _2666 = _2664;
    _2666[2] = texelFetch(sTransformPalette, _1262 + ivec2(2, 0), 0);
    mat4 _2668 = _2666;
    _2668[3] = texelFetch(sTransformPalette, _1262 + ivec2(3, 0), 0);
    vec4 _2625;
    if ((_1080 >> 24) == 0)
    {
        vec4 _1338 = _2668 * vec4(clamp(_2609 + (_2607 * aPosition.xy), _1047, _1047 + _1049), 0.0, 1.0);
        float _1354 = _1338.w;
    ...
    else
    {
        ...
        vec2 _1440 = _1438.xy;
        vec4 _1473 = _2668 * vec4((_2609 - _1440) + ((_2607 + (_1440 + _1438.zw)) * aPosition.xy), 0.0, 1.0);
        float _1481 = _1473.w;
        gl_Position = uTransform * vec4((_1473.xy * _1120) + ((_1154 - _1123) * _1481), _1074 * _1481, _1481);
        vTransformBounds = mix(vec4(clamp(_1041, _1047, _1531), clamp(_1041 + _1043, _1047, _1531)), vec4(clamp(_2609, _1047, _1531), clamp(_2609 + _2607, _1047, _1531)), _846);
        _2625 = _1473;
    }
    vec2 _1577 = (_2625.xy * _1120) / vec2(max(0.0, _2625.w));
