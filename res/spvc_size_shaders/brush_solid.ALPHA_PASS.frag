...
void main()
{
    ...
    switch (0u)
    {
        default:
        {
            ...
            _408 = 0.5 + (_327 * (((0.8431026935577392578125 * _327) * _327) - 1.14453601837158203125));
            break;
        }
    }
    highp float _410;
    switch (0u)
    {
        default:
        {
            ...
            _410 = texelFetch(sPrevPassAlpha, ivec3(ivec2(_366), int(vClipMaskUv.z + 0.5)), 0).x;
            break;
        }
    }
    oFragColor = (flat_varying_vec4_0 * _408) * _410;
}
