...
void main()
{
    ...
    _2237[1] = _1135;
    mat4 _2239 = _2237;
    _2239[2] = texelFetch(sTransformPalette, _1124 + ivec2(2, 0), 0);
    ...
    switch ((_1014 >> 8) & 255)
    {
        case 1:
        {
            _2143 = vec2(0.125, 0.5);
            break;
        }
        case 2:
        {
            _2143 = vec2(0.5, 0.125);
            break;
        }
        case 3:
        {
    ...
    vec2 _781 = (_1409.yz + floor((_745 * (vec2(_1357.x ? _1352.x : _1350.x, _1357.y ? _1352.y : _1350.y) + texelFetch(sPrimitiveHeadersF, _1042, 0).xy)) + _2143)) + (floor(((_745 * (vec2(texelFetch(sPrimitiveHeadersI, _1050, 0).xy) * vec2(0.00390625))) + _752) + vec2(0.5)) - _752);
    vec2 _784 = _1404.zw;
    vec2 _787 = _1404.xy;
    vec2 _788 = _784 - _787;
    vec2 _1429 = _788 * 0.5;
    ...
    {
        _2159 = _755 * (_781 + (_788 * aPosition.xy));
    }
    else
    {
        _2159 = _1451 + (_1453 * aPosition.xy);
    }
    vec2 _1491 = clamp(_2159, _1060, _1474);
    vec4 _838 = _2241 * vec4(_1491, 0.0, 1.0);
    vec2 _841 = _838.xy;
    float _861 = _838.w;
    ...
    vClipMaskUvBounds = vec4(_2124, _2124 + _2123);
    vClipMaskUv = vec4((_841 * _2121) + ((_2124 - _2120) * _861), _2122, _861);
    switch (_2202)
    {
        case 1:
        case 7:
