...
fn write_shader_file(shader_file_path: &Path, orig_shaders: Vec<PathBuf>) {
...
fn main() {
    ...
    let res_dir = Path::new("res/orig_shaders");
    ...
    write_shader_file(&shader_file_path, orig_shaders);
}
